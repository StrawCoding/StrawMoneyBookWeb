import{q as n,a as c,b as a,c as g,n as i,r as o,f as l,k as S}from"./app-google-Cb3fjEtF.js";import"./vendor-sqlite-DKEMZiEb.js";import"./app-membership-Bt_qfvcw.js";import"./app-i18n-BtVubweK.js";import"./vendor-CkjNk_C8.js";function A(t){return String(t??"").trim()==="daily"?"daily":"monthly"}function r(t){return String(t??"").trim()||null}function s(t){return t===!0||t===1||t==="1"}function p(t,e,d){return`${String(t??"").trim()}:${String(e??"").trim()}:${String(d??"").trim()}`}function N(t){return String(t??"").trim()==="pay_cycle"?"pay_cycle":"calendar_month"}function m(t,e){return String(t??"").trim()||String(e??"").trim()}function E(t="transactions"){const e=S(t);return`(CASE
