import{C as _e}from"./vendor-sqlite-DKEMZiEb.js";import{a1 as be,a2 as ve,E as ye,o as xe,w as Le,l as b,q as s,t as u,x as m,s as I,H as L,F as we,m as Se,e as w,c as A,M as Te,u as ke,j as $e,k as _,n as Ce}from"./vendor-CkjNk_C8.js";import{_ as ze,t as Ne,b as De,f as Ie,a6 as Ee,v as X,z as Ae,bZ as Fe,b$ as He,bY as Re}from"./index-DwIa3hJG.js";import{M}from"./MoneyText-m-Ng45mf.js";import{u as Me,b as J}from"./app-i18n-AXsF8jbs.js";import{g as Pe,d as Be}from"./claim-sheet-presentation-BC5ScFpD.js";import{af as qe,ah as Ue,ai as Y,ak as Oe,aj as We}from"./app-google-BpcjYB6v.js";import"./vendor-icons-BlwP1UUA.js";import"./app-membership-BLwAM0XK.js";const F=794,B=1123;function o(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Z(e,n="claim-sheet"){return String(e??"").replace(/[\\/:*?"<>|]/g,"_").replace(/\s+/g,"_").replace(/_+/g,"_").replace(/^_+|_+$/g,"")||n}function Ve(e,n="zh-TW"){if(!e)return"-";const a=new Date(e);return Number.isNaN(a.getTime())?"-":a.toLocaleString(n,{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"})}function je(e,n="zh-TW"){if(!e)return"-";const a=new Date(e);return Number.isNaN(a.getTime())?"-":a.toLocaleDateString(n,{year:"numeric",month:"2-digit",day:"2-digit"})}function q(e,n="zh-TW"){const a=Math.max(0,Math.round(Number(e??0)))/100;return new Intl.NumberFormat(n,{minimumFractionDigits:2,maximumFractionDigits:2}).format(a)}function Ge(e,n){return String(e?.source_type??"").trim()==="advance"?n.advanceType:String(e?.entry_type??"").trim()==="income"?n.incomeType:n.expenseType}function Xe(e,n){return String(e?.source_type??"").trim()==="advance"?n.advanceSource:String(e?.transaction_id??"").trim()?n.importedSource:n.manualSource}function Je(e={}){return{title:e.title||"請款單",detailTitle:e.detailTitle||"請款單明細",totalLabel:e.totalLabel||"請款淨額",statusLabel:e.statusLabel||"狀態",counterpartyLabel:e.counterpartyLabel||"請款對象",noteLabel:e.noteLabel||"備註",updatedAtLabel:e.updatedAtLabel||"更新時間",itemCountLabel:e.itemCountLabel||"項目數",categoryLabel:e.categoryLabel||"分類",descriptionLabel:e.descriptionLabel||"說明",amountLabel:e.amountLabel||"金額",dateLabel:e.dateLabel||"日期",sourceLabel:e.sourceLabel||"來源",importedNoteLabel:e.importedNoteLabel||"報銷備註",statusValue:e.statusValue||"",incomeType:e.incomeType||"收入",expenseType:e.expenseType||"支出",advanceType:e.advanceType||"代收",manualSource:e.manualSource||"手動項目",importedSource:e.importedSource||"導入報銷",advanceSource:e.advanceSource||"代收項目",emptyDescription:e.emptyDescription||"未命名項目",uncategorized:e.uncategorized||"未分類",summaryHint:e.summaryHint||"匯入報銷備註與手動代收項目均已納入此 PDF。"}}function Ye(){return`
  ...
  `}function Ze(){const e=document.createElement("div");return e.setAttribute("data-claim-sheet-pdf","true"),e.style.position="fixed",e.style.left="-99999px",e.style.top="0",e.style.width=`${F}px`,e.style.padding="0",e.style.background="#ffffff",e.style.zIndex="-1",e.innerHTML=Ye(),e}function Ke(e,n,a,t){return`
    <div class="claim-pdf">
      <header class="hero">
        <div>
  ...
  `}function K(e){return`${e}（續）`}function et(e,n,a,t,c){const l=String(e?.description??"").trim()||a.emptyDescription,d=String(e?.transaction_note??"").trim(),p=`${Ge(e,a)} / ${Xe(e,a)}`;return{amountText:q(e?.amount_minor,t),categoryName:c,dateText:je(e?.occurred_at,t),description:l,importedNote:d,indexLabel:String(n+1).padStart(2,"0"),itemSourceText:p}}function tt(e){return`
  ...
  `,c}function P(e,n,a){const t=document.createElement("article");return t.className="item-row item-row-note-continuation",t.innerHTML=`
    <div class="item-note-continuation-head">
      ...
      <div class="cell cell-description">
        <strong>${o(e.description)}</strong>
        <small>${o(K(n.importedNoteLabel))}</small>
      </div>
    </div>
    <div class="item-note-row item-note-row-continued">
      <span class="meta-label">${o(K(n.importedNoteLabel))}</span>
      <p>${o(a)}</p>
    </div>
