import{C as _e}from"./vendor-sqlite-DKEMZiEb.js";import{a1 as ve,a2 as be,E as ye,o as xe,w as Le,l as v,q as s,t as u,x as m,s as I,H as L,F as we,m as Se,e as w,c as A,M as Te,u as ke,j as $e,k as _,n as Ce}from"./vendor-CkjNk_C8.js";import{_ as ze,t as Ne,b as De,f as Ie,a6 as Ee,v as X,z as Ae,c3 as Fe,c5 as He,c2 as Re}from"./index-BrWXF6Dd.js";import{M}from"./MoneyText-eRkLQPIk.js";import{u as Me,b as J}from"./app-i18n-AXsF8jbs.js";import{g as Pe,d as Be}from"./claim-sheet-presentation-BPMoRiLw.js";import{af as qe,ah as Ue,ai as K,ak as Oe,aj as We}from"./app-google-W6UBk0p3.js";import"./vendor-icons-BlwP1UUA.js";import"./app-membership-DTbXKmUW.js";const F=794,B=1123;function o(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Q(e,n="claim-sheet"){return String(e??"").replace(/[\\/:*?"<>|]/g,"_").replace(/\s+/g,"_").replace(/_+/g,"_").replace(/^_+|_+$/g,"")||n}function Ve(e,n="zh-TW"){if(!e)return"-";const a=new Date(e);return Number.isNaN(a.getTime())?"-":a.toLocaleString(n,{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"})}function je(e,n="zh-TW"){if(!e)return"-";const a=new Date(e);return Number.isNaN(a.getTime())?"-":a.toLocaleDateString(n,{year:"numeric",month:"2-digit",day:"2-digit"})}function q(e,n="zh-TW"){const a=Math.max(0,Math.round(Number(e??0)))/100;return new Intl.NumberFormat(n,{minimumFractionDigits:2,maximumFractionDigits:2}).format(a)}function Ge(e,n){return String(e?.source_type??"").trim()==="advance"?n.advanceType:String(e?.entry_type??"").trim()==="income"?n.incomeType:n.expenseType}function Xe(e,n){return String(e?.source_type??"").trim()==="advance"?n.advanceSource:String(e?.transaction_id??"").trim()?n.importedSource:n.manualSource}function Je(e={}){return{title:e.title||"請款單",detailTitle:e.detailTitle||"請款單明細",totalLabel:e.totalLabel||"請款淨額",statusLabel:e.statusLabel||"狀態",counterpartyLabel:e.counterpartyLabel||"請款對象",noteLabel:e.noteLabel||"備註",updatedAtLabel:e.updatedAtLabel||"更新時間",itemCountLabel:e.itemCountLabel||"項目數",categoryLabel:e.categoryLabel||"分類",descriptionLabel:e.descriptionLabel||"說明",amountLabel:e.amountLabel||"金額",dateLabel:e.dateLabel||"日期",sourceLabel:e.sourceLabel||"來源",importedNoteLabel:e.importedNoteLabel||"報銷備註",statusValue:e.statusValue||"",incomeType:e.incomeType||"收入",expenseType:e.expenseType||"支出",advanceType:e.advanceType||"代收",manualSource:e.manualSource||"手動項目",importedSource:e.importedSource||"導入報銷",advanceSource:e.advanceSource||"代收項目",emptyDescription:e.emptyDescription||"未命名項目",uncategorized:e.uncategorized||"未分類",summaryHint:e.summaryHint||"匯入報銷備註與手動代收項目均已納入此 PDF。"}}function Ke(){return`
  ...
  `,t}function nt(e){const n=document.createElement("p");return n.className="empty-note",n.textContent=e.detailTitle,n}async function it(){await new Promise(e=>requestAnimationFrame(()=>requestAnimationFrame(e)))}async function ot(e){return await it(),be(e,{scale:2,backgroundColor:"#ffffff",useCORS:!0,logging:!1,width:F,height:B,windowWidth:F,windowHeight:B})}function te(e){return e.scrollHeight>e.clientHeight}function H(e,n){return e.body.appendChild(n),te(e.page)?(e.body.removeChild(n),!1):!0}function rt(e,n){const a=Math.max(1,Math.min(e.length,Math.floor(n)));if(a>=e.length)return e.length;const t=e.slice(0,a),c=t.lastIndexOf(`
`),l=t.lastIndexOf(" "),d=Math.max(c,l),p=Math.max(1,Math.floor(a*.6));return d>=p?d+1:a}function st(e,n,a){const t=String(n??"");if(!t)return null;let c=1,l=t.length,d=null;for(;c<=l;){const p=Math.floor((c+l)/2),b=rt(t,p),h=t.slice(0,b),f=a(h);e.body.appendChild(f);const g=!te(e.page);if(e.body.removeChild(f),g){d={consumedLength:b,text:h},c=p+1;continue}l=p-1}return d}function lt(e,n){return String(e??"").slice(n).replace(/^\s+/,"")}function ct(e,n,a,t){const c=ee(e,n,{noteText:""});H(a,c)||(a.body.childElementCount&&(a=t(!1)),H(a,c)||a.body.appendChild(c));let l=e.importedNote;for(;l;){const d=st(a,l,p=>P(e,n,p));if(!d){if(!a.body.childElementCount){a.body.appendChild(P(e,n,l));break}a=t(!1);continue}a.body.appendChild(P(e,n,d.text)),l=lt(l,d.consumedLength),l&&(a=t(!1))}return a}function dt(e,n={},a){const t=e?.claim??{},c=Array.isArray(e?.items)?e.items:[],l=n.locale||"zh-TW",d=Je(n),p=[];function b(f){const g=at(t,c,d,l,f);return a.appendChild(g.page),p.push(g),g}let h=b(!0);return c.forEach((f,g)=>{const y=n.categoryName?.(f?.category_id)||d.uncategorized,$=et(f,g,d,l,y),C=ee($,d);H(h,C)||(h.body.childElementCount&&(h=b(!1)),H(h,C)||(h=ct($,d,h,b)))}),p.forEach(({body:f})=>{f.childElementCount||f.appendChild(nt(d))}),{container:a,pages:p}}async function ut(e,n={}){if(typeof document>"u")throw new Error("目前環境不支援 PDF 匯出");const a=Qe();document.body.appendChild(a);const{pages:t}=dt(e,n,a);try{const c=new ve({orientation:"portrait",unit:"pt",format:"a4",compress:!0}),l=c.internal.pageSize.getWidth(),d=c.internal.pageSize.getHeight();for(const[h,{page:f}]of t.entries()){const y=(await ot(f)).toDataURL("image/png");h>0&&c.addPage(),c.addImage(y,"PNG",0,0,l,d,void 0,"FAST")}const p=Q(e?.claim?.title??n.title??"claim-sheet"),b=Q(e?.claim?.id??"claim");return{filename:`${p}_${b}.pdf`,blob:c.output("blob")}}finally{a.remove()}}const mt={class:"stack"},pt={class:"row"},ft={key:0,class:"card panel"},gt={class:"row claim-head"},ht={class:"claim-title"},_t={class:"muted"},vt={class:"detail-grid"},bt={class:"detail-row"},yt={class:"muted"},xt={class:"detail-row"},Lt={class:"muted"},wt={key:0,class:"detail-row"},St={class:"muted"},Tt={class:"detail-row"},kt={class:"muted"},$t={key:0,class:"note"},Ct={class:"row action-row"},zt=["disabled"],Nt=["disabled"],Dt=["disabled"],It=["disabled"],Et={key:1,class:"muted file-note"},At={key:2,class:"muted file-note"},Ft={key:3,class:"row export-open-row"},Ht={key:1,class:"card panel"},Rt={class:"row"},Mt={class:"detail-list"},Pt={class:"row detail-item-head"},Bt={class:"detail-item-title"},qt={class:"detail-meta"},Ut={class:"detail-badge muted"},Ot={class:"detail-badge muted"},Wt={class:"detail-badge muted"},Vt={key:0,class:"muted detail-note"},jt={key:2,class:"card panel"},Gt={class:"muted"},Xt={__name:"ClaimSheetDetailPage",setup(e){const n=ke(),a=Te(),{t,locale:c}=Me(),l=Ne(),d=De(),p=Ie(),b=Ee(),h=w(!1),f=w(!1),g=w(!1),y=w(!1),$=w(!1),C=w(!1),r=w(null),z=w([]),T=w(""),N=w(""),E=w(""),D=A(()=>String(n.params.id??"").trim()),ae=A(()=>Be(p.categories)),U=A(()=>{const i=String(n.query.tab??"").trim();return i==="completed"?"completed":i==="active"?"active":String(r.value?.status??"").trim()==="paid"?"completed":"active"}),O=A(()=>U.value==="completed"?{name:"claim-sheets",query:{tab:"completed"}}:{name:"claim-sheets"});ye(async()=>{await p.load(),await b.load()}),xe(()=>{W()}),Le([D,()=>d.activeLedgerId],()=>{re()},{immediate:!0});function W(){T.value.startsWith("blob:")&&qe(T.value)}function ne(i){return i?new Date(i).toLocaleString(J(c.value),{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"-"}function V(i){return t(i==="paid"?"claim_sheet.status.paid":i==="rejected"?"claim_sheet.status.rejected":i==="approved"?"claim_sheet.status.approved":i==="in_review"?"claim_sheet.status.in_review":i==="submitted"?"claim_sheet.status.submitted":"claim_sheet.status.draft")}function j(i){return String(i?.status??"draft")==="draft"}function G(i){return String(i?.status??"").trim()==="paid"}function ie(i){return Math.max(0,Math.round(Number(i?.amount_minor??0)))}function oe(i){const x=String(i??"").trim();return x?p.categories.find(R=>R.id===x)?.name??t("analysis_page.uncategorized"):t("analysis_page.uncategorized")}function k(i){return Pe(i,ae.value,t)}async function re(){if(!d.activeLedgerId||!D.value){r.value=null,z.value=[];return}h.value=!0;try{const i=await Re(d.activeLedgerId,D.value);if(D.value!==String(n.params.id??"").trim())return;r.value=i.claim??null,z.value=Array.isArray(i.items)?i.items:[]}catch(i){r.value=null,z.value=[],l.pushToast(i.message??t("claim_sheet.toast.load_failed"),"error")}finally{h.value=!1}}function se(){Ae(a,O.value)}function le(){!r.value?.id||!j(r.value)||a.push({name:"claim-sheet-edit",params:{id:D.value},query:U.value==="completed"?{tab:"completed"}:{}})}async function ce(){if(!(!r.value||f.value)){f.value=!0;try{const i=await ut({claim:r.value,items:z.value},{locale:J(c.value),title:t("claim_sheet.title"),detailTitle:t("claim_sheet.detail_title"),totalLabel:t("claim_sheet.form.net_total"),statusLabel:t("claim_sheet.status_label"),counterpartyLabel:t("claim_sheet.form.counterparty"),noteLabel:t("claim_sheet.form.note"),updatedAtLabel:t("transaction_about.detail.updated_at"),itemCountLabel:t("claim_sheet.item_count_label"),categoryLabel:t("transaction_about.detail.category"),descriptionLabel:t("claim_sheet.export_headers.description"),amountLabel:t("claim_sheet.export_headers.amount"),dateLabel:t("claim_sheet.export_headers.date"),sourceLabel:t("claim_sheet.export_headers.source"),importedNoteLabel:t("claim_sheet.form.import_note"),incomeType:t("claim_sheet.entry_type.income"),expenseType:t("claim_sheet.entry_type.expense"),advanceType:t("claim_sheet.entry_type.advance"),manualSource:t("claim_sheet.item_source.manual"),importedSource:t("claim_sheet.item_source.imported"),advanceSource:t("claim_sheet.item_source.advance"),emptyDescription:t("claim_sheet.form.unnamed_item"),uncategorized:t("analysis_page.uncategorized"),statusValue:V(r.value?.status),categoryName:x=>oe(x),summaryHint:t("claim_sheet.export_pdf_hint")});if(W(),N.value=i.filename,E.value="",_e.isNativePlatform()){const x=await Ue(i.filename,i.blob,{category:"claim-sheets"});if(x?.saved){N.value=String(x.filename??i.filename),E.value=String(x.location||t("claim_sheet.device_files")),T.value=String(x.uri??"").trim()||String(x.openUrl??"").trim()||K(i.blob),l.pushToast(t("claim_sheet.toast.exported_saved",{location:x.location||t("claim_sheet.device_files")}));return}}T.value=K(i.blob),l.pushToast(t("claim_sheet.toast.exported"))}catch(i){l.pushToast(i.message??t("claim_sheet.toast.export_failed"),"error")}finally{f.value=!1}}}function de(){if(!T.value)return;!Oe(T.value)&&N.value&&We(T.value,N.value)}function ue(){r.value&&($.value=!0)}function me(){!r.value||!G(r.value)||(C.value=!0)}function pe(){g.value||($.value=!1)}function fe(){y.value||(C.value=!1)}async function ge(){if(!(!d.activeLedgerId||!r.value?.id||y.value)){y.value=!0;try{const i=await Fe(d.activeLedgerId,r.value.id,"draft");r.value=i,await b.load(),l.pushToast(t("claim_sheet.toast.restored")),await a.replace({name:"claim-sheet-detail",params:{id:r.value.id}})}catch(i){l.pushToast(i.message??t("claim_sheet.toast.restore_failed"),"error")}finally{y.value=!1,C.value=!1}}}async function he(){if(!(!d.activeLedgerId||!r.value?.id||g.value)){g.value=!0;try{await He(d.activeLedgerId,r.value.id),await b.load(),l.pushToast(t("claim_sheet.toast.voided")),await a.replace(O.value)}catch(i){l.pushToast(i.message??t("claim_sheet.toast.void_failed"),"error")}finally{g.value=!1,$.value=!1}}}return(i,x)=>{const R=$e("font-awesome-icon");return _(),v("section",mt,[s("header",pt,[s("h2",null,u(m(t)("claim_sheet.detail_title")),1),s("button",{class:"btn back-btn",onClick:se},u(m(t)("common.back")),1)]),r.value?(_(),v("article",ft,[s("header",gt,[s("div",ht,[s("h3",null,u(r.value.title||m(t)("claim_sheet.detail_title")),1),s("small",_t,u(V(r.value.status)),1)]),I(M,{"value-minor":r.value.total_minor},null,8,["value-minor"])]),s("div",vt,[s("div",bt,[s("small",yt,u(m(t)("claim_sheet.net_amount")),1),s("span",null,[I(M,{"value-minor":r.value.total_minor},null,8,["value-minor"])])]),s("div",xt,[s("small",Lt,u(m(t)("claim_sheet.item_count_label")),1),s("span",null,u(z.value.length),1)]),r.value.counterparty_name?(_(),v("div",wt,[s("small",St,u(m(t)("claim_sheet.form.counterparty")),1),s("span",null,u(r.value.counterparty_name),1)])):L("",!0),s("div",Tt,[s("small",kt,u(m(t)("transaction_about.detail.updated_at")),1),s("span",null,u(ne(r.value.updated_at)),1)])]),r.value.note?(_(),v("p",$t,u(r.value.note),1)):L("",!0),s("div",Ct,[s("button",{class:"btn",disabled:!j(r.value),onClick:le},u(m(t)("common.edit")),9,zt),G(r.value)?(_(),v("button",{key:0,class:"btn",disabled:y.value,onClick:me},u(y.value?m(t)("claim_sheet.processing"):m(t)("claim_sheet.restore")),9,Nt)):L("",!0),s("button",{class:"btn",disabled:f.value,onClick:ce},u(f.value?m(t)("claim_sheet.processing"):m(t)("claim_sheet.export")),9,Dt),s("button",{class:"btn danger",disabled:g.value,onClick:ue},u(m(t)("common.delete")),9,It)]),N.value?(_(),v("p",Et,u(N.value),1)):L("",!0),E.value?(_(),v("p",At,u(E.value),1)):L("",!0),T.value?(_(),v("div",Ft,[s("button",{class:"btn",onClick:de},u(m(t)("analysis_print.open_link")),1)])):L("",!0)])):L("",!0),r.value?(_(),v("article",Ht,[s("header",Rt,[s("h3",null,u(m(t)("claim_sheet.item_count",{count:z.value.length})),1)]),s("ul",Mt,[(_(!0),v(we,null,Se(z.value,S=>(_(),v("li",{key:S.id,class:"detail-item"},[s("div",Pt,[s("div",Bt,[k(S).icon?(_(),Ce(R,{key:0,icon:k(S).icon,class:"detail-item-icon"},null,8,["icon"])):L("",!0),s("strong",null,u(k(S).title),1)]),I(M,{"value-minor":ie(S)},null,8,["value-minor"])]),s("div",qt,[s("span",Ut,u(k(S).entryLabel),1),s("span",Ot,u(k(S).sourceLabel),1),s("span",Wt,u(k(S).categoryName||m(t)("analysis_page.uncategorized")),1)]),k(S).note?(_(),v("p",Vt,u(k(S).note),1)):L("",!0)]))),128))])])):L("",!0),!r.value&&!h.value?(_(),v("article",jt,[s("p",Gt,u(m(t)("claim_sheet.not_found")),1)])):L("",!0),I(X,{open:C.value,title:m(t)("claim_sheet.restore_dialog.title"),message:r.value?m(t)("claim_sheet.confirm_restore",{title:r.value.title||r.value.id}):"","confirm-text":m(t)("claim_sheet.restore"),"confirm-disabled":y.value,loading:y.value,"loading-text":m(t)("claim_sheet.processing"),onClose:fe,onConfirm:ge},null,8,["open","title","message","confirm-text","confirm-disabled","loading","loading-text"]),I(X,{open:$.value,title:m(t)("claim_sheet.delete_dialog.title"),message:r.value?m(t)("claim_sheet.confirm_void",{title:r.value.title||r.value.id}):"","confirm-text":m(t)("common.delete"),"confirm-disabled":g.value,loading:g.value,"loading-text":m(t)("claim_sheet.processing"),onClose:pe,onConfirm:he},null,8,["open","title","message","confirm-text","confirm-disabled","loading","loading-text"])])}}},ia=ze(Xt,[["__scopeId","data-v-263de934"]]);export{ia as default};
