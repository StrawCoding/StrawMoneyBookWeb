const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/wear-sync-epoch.service-BC8Np1wZ.js","assets/vendor-sqlite-DKEMZiEb.js","assets/app-membership-DKxuerAa.js","assets/app-i18n-AXsF8jbs.js","assets/vendor-CkjNk_C8.js"])))=>i.map(i=>d[i]);
import{C as A,S as Rn,d as Kr,_ as bn,a as Dn,r as yn,D as an,F as Yr}from"./vendor-sqlite-DKEMZiEb.js";import{a as Wr,g as on}from"./app-membership-DKxuerAa.js";import{t as In}from"./app-i18n-AXsF8jbs.js";import{S as Se}from"./vendor-CkjNk_C8.js";const $r="straw.recovery_backup.v1",se="backups",qr=1,sn=40,te=Object.freeze({INDEXEDDB:"indexeddb",FILESYSTEM:"filesystem",TEST:"test"}),zr=new Set(Object.values(te));function Vr(){return typeof indexedDB>"u"||!indexedDB?null:new Promise((e,t)=>{const n=indexedDB.open($r,qr);n.onerror=()=>t(n.error||new Error("indexedDB open failed")),n.onupgradeneeded=()=>{const a=n.result;a.objectStoreNames.contains(se)||a.createObjectStore(se,{keyPath:"backupId"})},n.onsuccess=()=>e(n.result)})}async function Mt(e){const t=await Vr();if(!t)return null;try{return await e(t)}finally{try{t.close()}catch{}}}async function Jr(e){return await Mt(async n=>(await new Promise((a,r)=>{const i=n.transaction(se,"readwrite");i.oncomplete=()=>a(),i.onerror=()=>r(i.error||new Error("indexedDB put failed")),i.objectStore(se).put(e)}),!0)).catch(()=>!1)===!0}async function Cn(e){return Mt(async t=>new Promise((n,a)=>{const r=t.transaction(se,"readonly");r.onerror=()=>a(r.error||new Error("indexedDB get failed"));const i=r.objectStore(se).get(e);i.onsuccess=()=>n(i.result||null),i.onerror=()=>a(i.error||new Error("indexedDB get failed"))})).catch(()=>null)}async function Zr(){const e=await Mt(async t=>new Promise((n,a)=>{const r=t.transaction(se,"readonly");r.onerror=()=>a(r.error||new Error("indexedDB getAll failed"));const i=r.objectStore(se).getAll();i.onsuccess=()=>n(Array.isArray(i.result)?i.result:[]),i.onerror=()=>a(i.error||new Error("indexedDB getAll failed"))})).catch(()=>null);return Array.isArray(e)?e:[]}function Qr(e){return`recovery_${String(e).replace(/[^\w.-]+/g,"_").slice(0,40)||"wipe"}_${Date.now()}_${Math.random().toString(36).slice(2,10)}`}function Un(e){return typeof TextEncoder<"u"?new TextEncoder().encode(e).byteLength:String(e||"").length}function ea(e,t){if(!e||typeof e!="object")return null;const n=String(e.backupId||"").trim(),a=Number(e.byteLength)||0;return!n||!(a>0)?null:{backupId:n,purpose:String(e.purpose||"").trim(),at:String(e.at||"").trim(),byteLength:a,filename:String(e.filename||"").trim(),source:String(e.source||"").trim(),storage:String(t||e.storage||te.INDEXEDDB).trim(),hasPayload:!!e.jsonText}}function hn(e){if(!e||typeof e!="object"||e.verified!==!0||!(Number(e.byteLength)>0)||!String(e.backupId||"").trim())return!1;const t=String(e.storage||"").trim();return!!zr.has(t)}async function ta(e={}){const t=String(e.purpose||"wipe").trim()||"wipe",n=e.data;if(!n||typeof n!="object")throw new Error("recovery backup export payload missing");let a="";try{a=JSON.stringify(n)}catch(d){throw new Error(`recovery backup serialize failed: ${d?.message||d}`)}const r=Un(a);if(!(r>2))throw new Error("recovery backup payload empty");const i=Qr(t),o=new Date().toISOString(),s={backupId:i,purpose:t,at:o,byteLength:r,jsonText:a,source:String(e.source||"").trim(),filename:String(e.filename||"").trim()};if(await Jr(s)){const d=await Cn(i);if(d?.backupId===i&&Number(d.byteLength)>0&&d.jsonText)return{verified:!0,backupId:i,purpose:t,at:o,byteLength:r,storage:te.INDEXEDDB,filename:s.filename}}if(typeof e.persistToFilesystem=="function")try{const d=await e.persistToFilesystem({backupId:i,purpose:t,at:o,byteLength:r,jsonText:a,filename:s.filename,data:n});if(d?.verified===!0&&String(d.backupId||i)===i&&Number(d.byteLength||r)>0&&String(d.storage||"")===te.FILESYSTEM)return{verified:!0,backupId:i,purpose:t,at:o,byteLength:r,storage:te.FILESYSTEM,filename:s.filename,location:String(d.location||"").trim()}}catch{}throw new Error("recovery backup durable persist failed (memory is not durable proof)")}async function na(e){const t=String(e||"").trim();return t?Cn(t):null}async function Ed(e={}){const t=Math.max(1,Math.min(sn,Number(e.limit)||sn));let n=[];return n=await Zr(),(Array.isArray(n)?n:[]).map(r=>ea(r,r?.storage||te.INDEXEDDB)).filter(Boolean).sort((r,i)=>String(i.at).localeCompare(String(r.at))).slice(0,t)}async function ud(e){const t=await na(e),n=String(t?.jsonText||"");if(!t?.backupId||!(Number(t.byteLength)>0)||!n)throw new Error("recovery backup record missing or empty");return{backupId:t.backupId,purpose:String(t.purpose||""),at:String(t.at||""),byteLength:Number(t.byteLength)||Un(n),filename:String(t.filename||`${t.backupId}.json`),jsonText:n}}async function ld(e={}){const t=e.exportAllLedgersJson;if(typeof t!="function")throw new Error("recovery backup exporter missing");const n=String(e.purpose||"wipe").trim()||"wipe",a=String(e.filename||"").trim()||`strawmoneybook-recovery-before-${n}-${new Date().toISOString().replace(/[:.]/g,"-")}.json`,r=await t();let i=e.persistToFilesystem;!i&&typeof e.saveJsonFileToDevice=="function"&&(i=async({filename:s,data:c,backupId:d,byteLength:E})=>{const u=await e.saveJsonFileToDevice(s,c,{category:e.category||"recovery"});return u?.saved&&u.location?{verified:!0,backupId:d,byteLength:E,storage:te.FILESYSTEM,location:u.location}:null});const o=await ta({purpose:n,data:r,source:e.source,filename:a,persistToFilesystem:i});if(typeof e.saveJsonFileToDevice=="function"&&o.storage!==te.FILESYSTEM)try{const s=await e.saveJsonFileToDevice(a,r,{category:e.category||"recovery"});!(s?.saved&&s.location)&&typeof e.downloadJsonFile=="function"&&e.downloadJsonFile(a,r),s?.saved&&s.location&&typeof e.onDeviceSaved=="function"&&e.onDeviceSaved(s)}catch{if(typeof e.downloadJsonFile=="function")try{e.downloadJsonFile(a,r)}catch{}}else if(o.storage===te.FILESYSTEM&&typeof e.onDeviceSaved=="function")e.onDeviceSaved({saved:!0,location:o.location});else if(typeof e.downloadJsonFile=="function")try{e.downloadJsonFile(a,r)}catch{}if(!hn(o))throw new Error("recovery backup proof invalid after persist");return o}const ra=`PRAGMA foreign_keys = ON;
...
`,aa=`ALTER TABLE transactions ADD COLUMN is_reimbursable INTEGER NOT NULL DEFAULT 0 CHECK (is_reimbursable IN (0,1));
...
`,ia=`ALTER TABLE transactions ADD COLUMN include_in_budget INTEGER NOT NULL DEFAULT 1 CHECK (include_in_budget IN (0,1));
...
`,oa=`ALTER TABLE accounts ADD COLUMN icon TEXT DEFAULT 'fa-solid fa-wallet';
...
END
WHERE icon IS NULL OR TRIM(icon) = '';
`,da=`ALTER TABLE ledgers ADD COLUMN sort_order INTEGER NOT NULL DEFAULT 0;
...
`,ca=`-- Remove legacy sample transaction "飲食 300" if it is the only transaction in the ledger.
...
`,_a=`CREATE TABLE IF NOT EXISTS bank_connections (
  ledger_id TEXT NOT NULL,
  id TEXT NOT NULL,
...
`,Ea=`-- smb296: rebuild transactions under PRAGMA foreign_keys=ON.
...
PRAGMA foreign_keys = ON;
`,ua=`ALTER TABLE accounts ADD COLUMN include_in_assets INTEGER NOT NULL DEFAULT 1 CHECK (include_in_assets IN (0,1));

UPDATE accounts
SET include_in_assets = COALESCE(include_in_assets, 1);
`,la=`CREATE TABLE IF NOT EXISTS reimbursement_advances (
  ledger_id TEXT NOT NULL,
  id TEXT NOT NULL,
  account_id TEXT NOT NULL,
  source_tx_id TEXT,
...
`,ga=`ALTER TABLE reimbursement_advances
...
`,La=`CREATE TABLE IF NOT EXISTS savings_jars (
  ledger_id TEXT NOT NULL,
  account_id TEXT NOT NULL,
...
`,Na=`ALTER TABLE loan_payments ADD COLUMN generated_interest_tx_id TEXT;
`,pa=`ALTER TABLE accounts ADD COLUMN account_kind TEXT NOT NULL DEFAULT 'cash';
...
`,fa=`CREATE INDEX IF NOT EXISTS idx_deleted_log_lookup
...
END;
`,Aa=`ALTER TABLE bank_transactions ADD COLUMN transaction_type TEXT;
...
`,Oa=`ALTER TABLE reimbursement_items RENAME TO reimbursement_items__old_source_type;
...
CREATE INDEX IF NOT EXISTS idx_reimburse_items_claim ON reimbursement_items(ledger_id, reimbursement_id);
`,Sa=`ALTER TABLE savings_jars ADD COLUMN auto_save_source_account_id TEXT;
...
`,Ra=`ALTER TABLE budgets ADD COLUMN budget_save_total_enabled INTEGER NOT NULL DEFAULT 0;
...
`,ba=`-- smb296: rebuild transactions under PRAGMA foreign_keys=ON.
-- Composite child FKs use ON DELETE SET NULL / CASCADE; disabling foreign_keys is forbidden.
-- Detach nullable refs + backup/delete CASCADE children, rebuild parent, then restore.
PRAGMA foreign_keys = ON;
...
PRAGMA foreign_keys = ON;
`,Da=`ALTER TABLE reimbursement_advances ADD COLUMN return_amount_minor INTEGER;
`,ya=`ALTER TABLE accounts ADD COLUMN include_in_group_statistics INTEGER NOT NULL DEFAULT 1 CHECK (include_in_group_statistics IN (0,1));

UPDATE accounts
SET include_in_group_statistics = COALESCE(include_in_group_statistics, 1);
`,Ia=`DROP TABLE IF EXISTS invoice_carrier_invoices;
...
`,Ca=`CREATE TABLE IF NOT EXISTS einvoice_credentials (
  id        INTEGER PRIMARY KEY AUTOINCREMENT,
...
`,Ua=`ALTER TABLE einvoice_credentials ADD COLUMN password_iv TEXT NOT NULL DEFAULT '';
`,ha=`CREATE TABLE IF NOT EXISTS budget_containers (
  ledger_id TEXT NOT NULL,
  id TEXT NOT NULL,
  budget_id TEXT NOT NULL,
  name TEXT NOT NULL,
...
`,wa=`ALTER TABLE categories ADD COLUMN default_include_in_analysis INTEGER NOT NULL DEFAULT 1 CHECK (default_include_in_analysis IN (0,1));
...
`,ka=`ALTER TABLE transactions ADD COLUMN reimburse_target_minor INTEGER;
`,va=`CREATE TABLE IF NOT EXISTS einvoice_sync_config (
  id TEXT PRIMARY KEY,
  ledger_id TEXT,
...
`,Xa=`ALTER TABLE budget_containers ADD COLUMN period_mode TEXT NOT NULL DEFAULT 'monthly';
`,Fa=`ALTER TABLE ledgers ADD COLUMN budget_period_mode TEXT NOT NULL DEFAULT 'calendar_month';
...
`,Ma=`-- SMB-277: per-transaction editor attribution for shared ledgers
...
`,Ba=`CREATE TABLE IF NOT EXISTS securities (
  ledger_id TEXT NOT NULL,
  id TEXT NOT NULL,
...
`,xa=`-- smb300 securities v2 P1: settlement portfolio, settle_at / status, funds mode fields.
...
`,Ga=`-- smb301 credit card system P0 (v1.1 hard contracts)
PRAGMA foreign_keys = ON;
...
`,Pa=`-- Sell against a specific buy lot (1:1). Remaining qty/principal are derived.
PRAGMA foreign_keys = ON;
...
`,ja=`-- Wear OS Stage A: origin_type=wear CHECK, durable wear_applied identity, syncEpoch.
PRAGMA foreign_keys = ON;
...
BEGIN
  UPDATE wear_sync_state
   ...
   WHERE id = 1;
END;
`,Ha=`-- Migration 046 — bank sync Architecture B account checkpoints
...
WHERE IFNULL(last_full_success_at, '') = ''
  ...
  AND deleted_at IS NULL;
`,Ka=`-- Migration 047: restore deleted_log triggers lost by rebuild-by-rename
...
END;
`,Ya=`-- Migration 048: soft-delete postings when parent transaction is soft-deleted.
...
`?(s||(n+=m),o=!1,s=!1):s||(n+=m);continue}if(c){n+=m,m==="*"&&L==="/"&&(n+=L,T+=1,c=!1);continue}if(d){n+=m,m===d&&(d==="'"&&L==="'"?(n+=L,T+=1):d="");continue}if(m==="-"&&L==="-"){n+=m,n+=L,T+=1,E(),o=!0,s=!1;continue}if(m==="#"){E(),o=!0,s=!0;continue}if(m==="/"&&L==="*"){n+=m,n+=L,T+=1,E(),c=!0;continue}if(n+=m,m==="'"||m==='"'||m==="`"){E(),d=m;continue}/[A-Za-z0-9_]/.test(m)?a+=m:E(),m===";"&&(!i||r==="END")&&u()}return E(),u(),t}function Bt(e){const t=String(e?.message??e??"").toLowerCase();return t.includes("duplicate column name")||t.includes("already exists")||t.includes("duplicate index name")}function $a(e){return Wa(e).map(t=>({statement:t,values:[]}))}async function Ee(e,t){await e.executeSet([{statement:t,values:[]}])}function qa(e){return`mig_sp_${e}`}function za(e){return typeof e?.beginTransaction=="function"}function Va(e){return/^\s*ALTER\s+TABLE\b/i.test(String(e??""))}async function Ja(e,t){for(const n of t)try{await e.executeSet([n])}catch(a){if(!Bt(a))throw a}}async function Za(e,t){let n=!1;try{await Ee(e,"BEGIN;"),n=!0}catch{}try{for(let a=0;a<t.length;a+=1){const r=t[a],i=Va(r.statement),o=qa(a);i&&await Ee(e,`SAVEPOINT ${o};`);try{await e.executeSet([r]),i&&await Ee(e,`RELEASE ${o};`)}catch(s){if(i){try{await Ee(e,`ROLLBACK TO ${o};`)}catch{}try{await Ee(e,`RELEASE ${o};`)}catch{}}if(!Bt(s))throw s}}n&&await Ee(e,"COMMIT;")}catch(a){if(n)try{await Ee(e,"ROLLBACK;")}catch{}throw a}}async function Qa(e,t){const n=$a(t);if(n.length){if(za(e)){await Ja(e,n);return}await Za(e,n)}}const ei=Object.freeze([20,21,22,27,29]);function ti(e){const t=new Set(ei),n=[...new Set((e??[]).map(a=>Number(a?.version)).filter(a=>t.has(a)))].sort((a,r)=>a-r);if(n.length>0)throw new Error(`Do NOT reuse reserved migration versions ${n.join(", ")} — existing devices would skip the new SQL.`)}const ni="APP_DOWNGRADE_BLOCKED",wn="data_floor_app_version",kn="data_floor_schema_version",xt="straw.data_floor.v1";function vn(){return String(Wr?.version).trim()}function dn(e){const t=String(e??"").trim().replace(/^v/i,"").match(/\d+/g);return t?.length?t.map(n=>Number.parseInt(String(n),10)).map(n=>Number.isFinite(n)?Math.max(0,n):0):[]}function It(e,t){const n=dn(e),a=dn(t),r=Math.max(n.length,a.length,3);for(let i=0;i<r;i+=1){const o=Number(n[i]??0),s=Number(a[i]??0);if(o>s)return 1;if(o<s)return-1}return 0}function ri(e={}){const t=String(e.reason??"unknown").trim()||"unknown",n=String(e.floorAppVersion??"").trim(),a=String(e.currentAppVersion??"").trim(),r=Number(e.floorSchemaVersion??0),i=Number(e.knownSchemaMax??0);let o="偵測到本機資料曾由較新版本寫入。為避免資料回損，已阻止此舊版開啟帳本。請改安裝相同或更新的版本。";t==="schema_ahead"?o=`本機資料庫 schema（${r}）高於此 App 支援上限（${i}）。為避免資料回損，已阻止開啟。請改安裝較新版本。`:t==="app_version_ahead"&&n&&a&&(o=`本機資料曾由 App ${n} 寫入，目前版本為 ${a}。為避免資料回損，已阻止開啟。請改安裝 ${n} 或更新版本。`);const s=new Error(o);return s.code=ni,s.i18nKey="app.downgrade_blocked",s.reason=t,s.floorAppVersion=n||null,s.currentAppVersion=a||null,s.floorSchemaVersion=Number.isFinite(r)?r:null,s.knownSchemaMax=Number.isFinite(i)?i:null,s.recoverable=!1,s.silentWipeBlocked=!0,s}function Gt(){try{return globalThis.localStorage??null}catch{return null}}function Xn(){const e=Gt();if(!e)return{appVersion:"",schemaVersion:0};try{const t=e.getItem(xt);if(!t)return{appVersion:"",schemaVersion:0};const n=JSON.parse(t);return{appVersion:String(n?.appVersion??"").trim(),schemaVersion:Number.parseInt(String(n?.schemaVersion??"0"),10)||0}}catch{return{appVersion:"",schemaVersion:0}}}function ai({appVersion:e,schemaVersion:t}={}){const n=Gt();if(!n)return;const a=String(e??"").trim(),r=Number.parseInt(String(t??"0"),10)||0,i=Xn(),o=a&&(!i.appVersion||It(a,i.appVersion)>0)?a:i.appVersion,s=Math.max(i.schemaVersion||0,r||0);try{n.setItem(xt,JSON.stringify({appVersion:o,schemaVersion:s,updatedAt:new Date().toISOString()}))}catch{}}function ii(){const e=Gt();if(e)try{e.removeItem(xt)}catch{}}function oi({knownSchemaMax:e,dbMaxSchemaVersion:t=0,floorSchemaVersion:n=0,prefsSchemaVersion:a=0,floorAppVersion:r="",prefsAppVersion:i="",currentAppVersion:o=""}={}){const s=Number(e??0)||0,c=Number(t??0)||0,d=Math.max(Number(n??0)||0,Number(a??0)||0,c);if(s>0&&d>s)return{reason:"schema_ahead",floorSchemaVersion:d,knownSchemaMax:s,currentAppVersion:o,floorAppVersion:r||i||""};const E=(()=>{const T=String(r??"").trim(),m=String(i??"").trim();return T&&m?It(T,m)>=0?T:m:T||m})(),u=String(o??"").trim();return E&&u&&It(u,E)<0?{reason:"app_version_ahead",floorAppVersion:E,currentAppVersion:u,floorSchemaVersion:d,knownSchemaMax:s}:null}function si(e={}){const t=oi(e);if(t)throw ri(t)}const Pt=[{version:1,name:"init_schema",sql:ra},{version:2,name:"transaction_reimbursement_flags",sql:aa},{version:3,name:"transaction_budget_analysis_flags",sql:ia},{version:4,name:"account_category_icons",sql:oa},{version:5,name:"default_icons_backfill",sql:sa},{version:6,name:"ledger_sort_order",sql:da},{version:7,name:"remove_default_sample_transaction",sql:ca},{version:8,name:"bank_sync",sql:_a},{version:9,name:"allow_zero_amount_transaction",sql:Ea},{version:10,name:"account_include_in_assets",sql:ua},{version:11,name:"reimbursement_advances",sql:la},{version:12,name:"reimbursement_item_entry_type",sql:Ta},{version:13,name:"budget_item_daily_rules",sql:ma},{version:14,name:"reimbursement_advance_category",sql:ga},{version:15,name:"savings_jars",sql:La},{version:16,name:"loan_payment_interest_tx",sql:Na},{version:17,name:"account_credit_profile",sql:pa},{version:18,name:"shared_sync_deleted_log",sql:fa},{version:19,name:"bank_transaction_metadata",sql:Aa},{version:23,name:"reimbursement_item_advance_source",sql:Oa},{version:24,name:"savings_jars_auto_save",sql:Sa},{version:25,name:"budget_save",sql:Ra},{version:26,name:"transaction_origin_type_refund",sql:ba},{version:28,name:"advance_return_amount",sql:Da},{version:30,name:"account_group_statistics",sql:ya},{version:31,name:"remove_invoice_carrier",sql:Ia},{version:32,name:"einvoice_import",sql:Ca},{version:33,name:"einvoice_credential_password_iv",sql:Ua},{version:34,name:"budget_containers",sql:ha},{version:35,name:"category_default_flags",sql:wa},{version:36,name:"transaction_reimburse_target",sql:ka},{version:37,name:"einvoice_carrier_sync",sql:va},{version:38,name:"budget_container_period_mode",sql:Xa},{version:39,name:"budget_pay_cycle",sql:Fa},{version:40,name:"transaction_editor_attribution",sql:Ma},{version:41,name:"securities",sql:Ba},{version:42,name:"securities_settlement_v2",sql:xa},{version:43,name:"credit_card_system_p0",sql:Ga},{version:44,name:"security_sell_source_buy",sql:Pa},{version:45,name:"wear_companion",sql:ja},{version:46,name:"bank_sync_account_checkpoints",sql:Ha},{version:47,name:"restore_deleted_log_triggers",sql:Ka},{version:48,name:"soft_delete_transaction_postings",sql:Ya}];ti(Pt);function Fn(){return Pt.reduce((e,t)=>Math.max(e,Number(t.version)||0),0)}const cn="legacy_schema_patched_v1",di={ledgers:["ALTER TABLE ledgers ADD COLUMN currency_code TEXT NOT NULL DEFAULT 'TWD';","ALTER TABLE ledgers ADD COLUMN timezone TEXT NOT NULL DEFAULT 'Asia/Taipei';","ALTER TABLE ledgers ADD COLUMN color TEXT;","ALTER TABLE ledgers ADD COLUMN icon TEXT;","ALTER TABLE ledgers ADD COLUMN sort_order INTEGER NOT NULL DEFAULT 0;","ALTER TABLE ledgers ADD COLUMN is_archived INTEGER NOT NULL DEFAULT 0;","ALTER TABLE ledgers ADD COLUMN created_at TEXT;","ALTER TABLE ledgers ADD COLUMN updated_at TEXT;","ALTER TABLE ledgers ADD COLUMN deleted_at TEXT;"],account_groups:["ALTER TABLE account_groups ADD COLUMN sort_order INTEGER NOT NULL DEFAULT 0;","ALTER TABLE account_groups ADD COLUMN is_archived INTEGER NOT NULL DEFAULT 0;","ALTER TABLE account_groups ADD COLUMN deleted_at TEXT;","ALTER TABLE account_groups ADD COLUMN created_at TEXT;","ALTER TABLE account_groups ADD COLUMN updated_at TEXT;"],accounts:["ALTER TABLE accounts ADD COLUMN group_id TEXT;","ALTER TABLE accounts ADD COLUMN account_type TEXT NOT NULL DEFAULT 'asset';","ALTER TABLE accounts ADD COLUMN account_kind TEXT NOT NULL DEFAULT 'cash';","ALTER TABLE accounts ADD COLUMN allow_negative INTEGER NOT NULL DEFAULT 0;","ALTER TABLE accounts ADD COLUMN include_in_assets INTEGER NOT NULL DEFAULT 1;","ALTER TABLE accounts ADD COLUMN include_in_group_statistics INTEGER NOT NULL DEFAULT 1;","ALTER TABLE accounts ADD COLUMN opening_balance_minor INTEGER NOT NULL DEFAULT 0;","ALTER TABLE accounts ADD COLUMN currency_code TEXT NOT NULL DEFAULT 'TWD';","ALTER TABLE accounts ADD COLUMN icon TEXT;","ALTER TABLE accounts ADD COLUMN credit_limit_minor INTEGER NOT NULL DEFAULT 0;","ALTER TABLE accounts ADD COLUMN repayment_reminder_day INTEGER;","ALTER TABLE accounts ADD COLUMN statement_close_day INTEGER;","ALTER TABLE accounts ADD COLUMN payment_due_day INTEGER;","ALTER TABLE accounts ADD COLUMN card_last4 TEXT;","ALTER TABLE accounts ADD COLUMN issuer TEXT;","ALTER TABLE accounts ADD COLUMN sort_order INTEGER NOT NULL DEFAULT 0;","ALTER TABLE accounts ADD COLUMN is_archived INTEGER NOT NULL DEFAULT 0;","ALTER TABLE accounts ADD COLUMN deleted_at TEXT;","ALTER TABLE accounts ADD COLUMN created_at TEXT;","ALTER TABLE accounts ADD COLUMN updated_at TEXT;"],category_groups:["ALTER TABLE category_groups ADD COLUMN sort_order INTEGER NOT NULL DEFAULT 0;","ALTER TABLE category_groups ADD COLUMN is_archived INTEGER NOT NULL DEFAULT 0;","ALTER TABLE category_groups ADD COLUMN deleted_at TEXT;","ALTER TABLE category_groups ADD COLUMN created_at TEXT;","ALTER TABLE category_groups ADD COLUMN updated_at TEXT;"],categories:["ALTER TABLE categories ADD COLUMN group_id TEXT;","ALTER TABLE categories ADD COLUMN kind TEXT NOT NULL DEFAULT 'expense';","ALTER TABLE categories ADD COLUMN icon TEXT;","ALTER TABLE categories ADD COLUMN is_budgetable INTEGER NOT NULL DEFAULT 1;","ALTER TABLE categories ADD COLUMN sort_order INTEGER NOT NULL DEFAULT 0;","ALTER TABLE categories ADD COLUMN is_archived INTEGER NOT NULL DEFAULT 0;","ALTER TABLE categories ADD COLUMN deleted_at TEXT;","ALTER TABLE categories ADD COLUMN created_at TEXT;","ALTER TABLE categories ADD COLUMN updated_at TEXT;"],transactions:["ALTER TABLE transactions ADD COLUMN type TEXT NOT NULL DEFAULT 'expense';","ALTER TABLE transactions ADD COLUMN transfer_group_id TEXT;","ALTER TABLE transactions ADD COLUMN account_id TEXT;","ALTER TABLE transactions ADD COLUMN peer_account_id TEXT;","ALTER TABLE transactions ADD COLUMN category_id TEXT;","ALTER TABLE transactions ADD COLUMN amount_minor INTEGER;","ALTER TABLE transactions ADD COLUMN occurred_at TEXT;","ALTER TABLE transactions ADD COLUMN posted_at TEXT;","ALTER TABLE transactions ADD COLUMN note TEXT;","ALTER TABLE transactions ADD COLUMN location TEXT;","ALTER TABLE transactions ADD COLUMN tags_json TEXT;","ALTER TABLE transactions ADD COLUMN origin_type TEXT NOT NULL DEFAULT 'manual';","ALTER TABLE transactions ADD COLUMN external_ref_id TEXT;","ALTER TABLE transactions ADD COLUMN idempotency_key TEXT;","ALTER TABLE transactions ADD COLUMN include_in_budget INTEGER NOT NULL DEFAULT 1;","ALTER TABLE transactions ADD COLUMN include_in_analysis INTEGER NOT NULL DEFAULT 1;","ALTER TABLE transactions ADD COLUMN deleted_at TEXT;","ALTER TABLE transactions ADD COLUMN created_at TEXT;","ALTER TABLE transactions ADD COLUMN updated_at TEXT;","ALTER TABLE transactions ADD COLUMN created_by_user_id TEXT;","ALTER TABLE transactions ADD COLUMN created_by_display_name TEXT;","ALTER TABLE transactions ADD COLUMN updated_by_user_id TEXT;","ALTER TABLE transactions ADD COLUMN updated_by_display_name TEXT;"],transaction_attachments:["ALTER TABLE transaction_attachments ADD COLUMN file_uri TEXT;","ALTER TABLE transaction_attachments ADD COLUMN mime_type TEXT;","ALTER TABLE transaction_attachments ADD COLUMN file_size INTEGER;","ALTER TABLE transaction_attachments ADD COLUMN checksum TEXT;","ALTER TABLE transaction_attachments ADD COLUMN created_at TEXT;"],counterparties:["ALTER TABLE counterparties ADD COLUMN contact_json TEXT;","ALTER TABLE counterparties ADD COLUMN note TEXT;","ALTER TABLE counterparties ADD COLUMN is_archived INTEGER NOT NULL DEFAULT 0;","ALTER TABLE counterparties ADD COLUMN created_at TEXT;","ALTER TABLE counterparties ADD COLUMN updated_at TEXT;"],loans:["ALTER TABLE loans ADD COLUMN counterparty_id TEXT;","ALTER TABLE loans ADD COLUMN direction TEXT NOT NULL DEFAULT 'lend';","ALTER TABLE loans ADD COLUMN principal_minor INTEGER NOT NULL DEFAULT 0;","ALTER TABLE loans ADD COLUMN interest_rule_json TEXT;","ALTER TABLE loans ADD COLUMN start_date TEXT;","ALTER TABLE loans ADD COLUMN due_date TEXT;","ALTER TABLE loans ADD COLUMN status TEXT NOT NULL DEFAULT 'active';","ALTER TABLE loans ADD COLUMN settled_at TEXT;","ALTER TABLE loans ADD COLUMN note TEXT;","ALTER TABLE loans ADD COLUMN created_at TEXT;","ALTER TABLE loans ADD COLUMN updated_at TEXT;","ALTER TABLE loans ADD COLUMN deleted_at TEXT;"],loan_payments:["ALTER TABLE loan_payments ADD COLUMN loan_id TEXT;","ALTER TABLE loan_payments ADD COLUMN account_id TEXT;","ALTER TABLE loan_payments ADD COLUMN paid_at TEXT;","ALTER TABLE loan_payments ADD COLUMN amount_minor INTEGER;","ALTER TABLE loan_payments ADD COLUMN principal_component_minor INTEGER;","ALTER TABLE loan_payments ADD COLUMN interest_component_minor INTEGER;","ALTER TABLE loan_payments ADD COLUMN generated_tx_id TEXT;","ALTER TABLE loan_payments ADD COLUMN generated_interest_tx_id TEXT;","ALTER TABLE loan_payments ADD COLUMN note TEXT;","ALTER TABLE loan_payments ADD COLUMN created_at TEXT;","ALTER TABLE loan_payments ADD COLUMN updated_at TEXT;"],reimbursements:["ALTER TABLE reimbursements ADD COLUMN title TEXT;","ALTER TABLE reimbursements ADD COLUMN counterparty_id TEXT;","ALTER TABLE reimbursements ADD COLUMN status TEXT NOT NULL DEFAULT 'draft';","ALTER TABLE reimbursements ADD COLUMN submitted_at TEXT;","ALTER TABLE reimbursements ADD COLUMN approved_at TEXT;","ALTER TABLE reimbursements ADD COLUMN paid_at TEXT;","ALTER TABLE reimbursements ADD COLUMN paid_tx_id TEXT;","ALTER TABLE reimbursements ADD COLUMN total_minor INTEGER NOT NULL DEFAULT 0;","ALTER TABLE reimbursements ADD COLUMN note TEXT;","ALTER TABLE reimbursements ADD COLUMN idempotency_key TEXT;","ALTER TABLE reimbursements ADD COLUMN created_at TEXT;","ALTER TABLE reimbursements ADD COLUMN updated_at TEXT;","ALTER TABLE reimbursements ADD COLUMN deleted_at TEXT;"],reimbursement_items:["ALTER TABLE reimbursement_items ADD COLUMN source_type TEXT NOT NULL DEFAULT 'manual';","ALTER TABLE reimbursement_items ADD COLUMN entry_type TEXT NOT NULL DEFAULT 'expense';","ALTER TABLE reimbursement_items ADD COLUMN transaction_id TEXT;","ALTER TABLE reimbursement_items ADD COLUMN category_id TEXT;","ALTER TABLE reimbursement_items ADD COLUMN account_id TEXT;","ALTER TABLE reimbursement_items ADD COLUMN description TEXT;","ALTER TABLE reimbursement_items ADD COLUMN amount_minor INTEGER;","ALTER TABLE reimbursement_items ADD COLUMN occurred_at TEXT;","ALTER TABLE reimbursement_items ADD COLUMN attachment_uri TEXT;","ALTER TABLE reimbursement_items ADD COLUMN created_at TEXT;","ALTER TABLE reimbursement_items ADD COLUMN updated_at TEXT;"],reimbursement_advances:["ALTER TABLE reimbursement_advances ADD COLUMN category_id TEXT;"],budgets:["ALTER TABLE budgets ADD COLUMN name TEXT;","ALTER TABLE budgets ADD COLUMN include_transfers INTEGER NOT NULL DEFAULT 0;","ALTER TABLE budgets ADD COLUMN include_loan_repayments INTEGER NOT NULL DEFAULT 0;","ALTER TABLE budgets ADD COLUMN include_reimbursed_expenses INTEGER NOT NULL DEFAULT 0;","ALTER TABLE budgets ADD COLUMN budget_save_total_enabled INTEGER NOT NULL DEFAULT 0;","ALTER TABLE budgets ADD COLUMN budget_save_total_target_account_id TEXT;","ALTER TABLE budgets ADD COLUMN budget_save_total_source_account_id TEXT;","ALTER TABLE budgets ADD COLUMN created_at TEXT;","ALTER TABLE budgets ADD COLUMN updated_at TEXT;","ALTER TABLE budgets ADD COLUMN deleted_at TEXT;"],budget_items:["ALTER TABLE budget_items ADD COLUMN scope_type TEXT NOT NULL DEFAULT 'category';","ALTER TABLE budget_items ADD COLUMN category_id TEXT;","ALTER TABLE budget_items ADD COLUMN category_group_id TEXT;","ALTER TABLE budget_items ADD COLUMN amount_minor INTEGER NOT NULL DEFAULT 0;","ALTER TABLE budget_items ADD COLUMN amount_mode TEXT NOT NULL DEFAULT 'fixed';","ALTER TABLE budget_items ADD COLUMN day_rule_unit TEXT NOT NULL DEFAULT 'none';","ALTER TABLE budget_items ADD COLUMN day_rule_values_json TEXT NOT NULL DEFAULT '[]';","ALTER TABLE budget_items ADD COLUMN budget_save_enabled INTEGER NOT NULL DEFAULT 0;","ALTER TABLE budget_items ADD COLUMN budget_save_target_account_id TEXT;","ALTER TABLE budget_items ADD COLUMN budget_save_source_account_id TEXT;","ALTER TABLE budget_items ADD COLUMN sort_order INTEGER NOT NULL DEFAULT 0;","ALTER TABLE budget_items ADD COLUMN created_at TEXT;","ALTER TABLE budget_items ADD COLUMN updated_at TEXT;"],savings_jars:["ALTER TABLE savings_jars ADD COLUMN auto_save_source_account_id TEXT;","ALTER TABLE savings_jars ADD COLUMN auto_save_amount_minor INTEGER;","ALTER TABLE savings_jars ADD COLUMN auto_save_interval_value INTEGER;","ALTER TABLE savings_jars ADD COLUMN auto_save_interval_unit TEXT;","ALTER TABLE savings_jars ADD COLUMN auto_save_start_date TEXT;","ALTER TABLE savings_jars ADD COLUMN auto_save_charge_day INTEGER;","ALTER TABLE savings_jars ADD COLUMN auto_save_paused INTEGER NOT NULL DEFAULT 0;"],app_settings:["ALTER TABLE app_settings ADD COLUMN value_json TEXT;","ALTER TABLE app_settings ADD COLUMN updated_at TEXT;"],deleted_log:["ALTER TABLE deleted_log ADD COLUMN payload_json TEXT;","ALTER TABLE deleted_log ADD COLUMN deleted_at TEXT;"],security_transactions:["ALTER TABLE security_transactions ADD COLUMN source_buy_tx_id TEXT;"]};async function Q(e,t){return!!(await e.query(`SELECT 1 AS ok
  ...
  `)}async function Ct(e,t){const n=await e.query(`SELECT value
     ...
     ON CONFLICT(key) DO UPDATE SET
       ...
       updated_at = excluded.updated_at;`,[t,String(n??"")])}async function Mn(e){try{const t=await e.query("SELECT MAX(version) AS max_version FROM schema_migrations;");return Number.parseInt(String(t?.values?.[0]?.max_version??"0"),10)||0}catch{return 0}}async function ui(e){const t=Fn(),n=await Mn(e),a=await Ct(e,wn).catch(()=>""),r=await Ct(e,kn).catch(()=>""),i=Number.parseInt(String(r||"0"),10)||0,o=Xn();si({knownSchemaMax:t,dbMaxSchemaVersion:n,floorSchemaVersion:i,prefsSchemaVersion:o.schemaVersion,floorAppVersion:a,prefsAppVersion:o.appVersion,currentAppVersion:vn()})}async function li(e){const t=Fn(),n=await Mn(e),a=Math.max(t,n),r=vn();r&&await Ut(e,wn,r),await Ut(e,kn,String(a)),ai({appVersion:r,schemaVersion:a})}async function Ti(e){await Ei(e),await Ct(e,cn).then(r=>r==="1").catch(()=>!1)||(await _i(e),await Ut(e,cn,"1")),await e.execute(`
    CREATE TABLE IF NOT EXISTS schema_migrations (
      version INTEGER PRIMARY KEY,
      name TEXT NOT NULL,
      applied_at TEXT NOT NULL DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ','now'))
    );
  `),await ui(e);const n=await e.query("SELECT version FROM schema_migrations ORDER BY version ASC;"),a=new Set((n?.values??[]).map(r=>r.version));for(const r of Pt)a.has(r.version)||(await Qa(e,r.sql),await e.run("INSERT INTO schema_migrations (version, name) VALUES (?, ?);",[r.version,r.name]));await li(e)}let mi=1,Qe=null;function gi(){const e=mi++;return{id:`txctx_${e}_${Date.now().toString(36)}`,token:`tok_${e}_${Math.random().toString(36).slice(2,10)}`,depth:0,status:"open"}}function Bn(){return Qe}async function Li(e,t){const n=Qe;Qe=e;try{return await t()}finally{Qe=n}}class Ni{constructor(){this._tail=Promise.resolve(),this._pending=0}get pendingCount(){return this._pending}enqueue(t){this._pending+=1;const n=this._tail.then(()=>t());return this._tail=n.then(()=>{this._pending=Math.max(0,this._pending-1)},()=>{this._pending=Math.max(0,this._pending-1)}),n}}const pi=new Ni,fi="/app/assets".replace(/\/{2,}/g,"/");let we=null,ft=null;async function Ai(){if(!customElements.get("jeep-sqlite")){if(ft||(ft=(async()=>{try{await Kr(window)}catch(e){console.warn("[sqlite] loader registration failed, fallback to esm bundle",e),await bn(()=>import("./vendor-sqlite-DKEMZiEb.js").then(t=>t.j),[])}})()),await ft,!customElements.get("jeep-sqlite"))throw new Error("jeep-sqlite custom element registration failed");await customElements.whenDefined("jeep-sqlite")}}async function Oi(){if(A.getPlatform()==="web")return we||(we=(async()=>{await Ai();const e=document.querySelector("jeep-sqlite")??document.createElement("jeep-sqlite");e.setAttribute("wasm-path",fi),e.parentElement||document.body.appendChild(e),await Promise.resolve(),await new Rn(Dn).initWebStore()})().catch(e=>{throw we=null,e}),we)}const Si=Object.freeze({USER_RESET_ALL:"user_reset_all",USER_IMPORT_JSON:"user_import_json",USER_RESTORE_GOOGLE_BACKUP:"user_restore_google_backup",USER_RESTORE_WEBDAV_BACKUP:"user_restore_webdav_backup",USER_RESTORE_LOCAL_RECOVERY:"user_restore_local_recovery"}),Ri="LOCAL_DB_INTEGRITY",bi="EMPTY_REMOTE_REPLACE_BLOCKED",Di="DATA_WIPE_DENIED",xn="straw.data_wipe_audit.v1",jt=40,yi=new Set(Object.values(Si));function At(e,t={}){const n=String(e?.message??e??"").trim(),a=String(t.message??"").trim()||"本機資料庫無法安全開啟。系統不會自動清空帳本；請從備份／Google Drive／匯入還原，或至資料管理明確重設。",r=new Error(a);if(r.code=Ri,r.i18nKey=t.i18nKey||"app.local_db_integrity",r.originalMessage=n,r.recoverable=!1,r.silentWipeBlocked=!0,e&&typeof e=="object")try{r.cause=e}catch{}return r}function Td(e={}){const t=Number(e.localTransactionCount??0),n=Number(e.remoteTransactionCount??0),a=String(e.message??"").trim()||`遠端帳本快照交易數（${n}）為空，但本機仍有 ${t} 筆交易；已阻止覆蓋以避免 silent wipe。請改用合併同步、從備份還原，或在確認後以匯入／重設路徑處理。`,r=new Error(a);return r.code=bi,r.i18nKey=e.i18nKey||"settings_google_sync.error.empty_remote_replace_blocked",r.localTransactionCount=t,r.remoteTransactionCount=n,r.silentWipeBlocked=!0,r}function Ii(e={}){const t=String(e.reason??"").trim(),n=String(e.source??"").trim();if(!(e.confirmed===!0)||!yi.has(t)||!n){const r=new Error("本機資料清空被拒絕：缺少使用者確認或合法 wipe 理由。FK／migration／bootstrap 不得靜默 wipe。");throw r.code=Di,r.i18nKey="sqlite.error.data_wipe_denied",r.silentWipeBlocked=!0,r}return{reason:t,source:n,confirmed:!0}}function Ci(){if(typeof localStorage>"u")return[];try{const e=localStorage.getItem(xn),t=e?JSON.parse(e):[];return Array.isArray(t)?t:[]}catch{return[]}}function Ui(e){if(!(typeof localStorage>"u"))try{localStorage.setItem(xn,JSON.stringify(e.slice(0,jt)))}catch{}}function hi(e={}){const t={at:String(e.at??new Date().toISOString()),reason:String(e.reason??""),source:String(e.source??""),confirmed:e.confirmed===!0,note:String(e.note??"").slice(0,240)},n=[t,...Ci()].slice(0,jt);return Ui(n),typeof console<"u"&&typeof console.info=="function"&&console.info("[data-wipe-audit]",t),t}const Ht="RECOVERY_BACKUP_REQUIRED";function Ot(e,t={}){const n=String(e?.message??e??"").trim(),a=String(t.message??"").trim()||"本機 recovery 備份建立失敗，已中止清空本機資料。請先手動匯出備份後再重試還原／匯入／重設。",r=new Error(a);if(r.code=Ht,r.i18nKey=t.i18nKey||"settings_data.toast.recovery_backup_required",r.source=String(t.source??"").trim(),r.originalMessage=n,r.silentWipeBlocked=!0,e&&typeof e=="object")try{r.cause=e}catch{}return r}async function wi(e,t={}){if(typeof e!="function")throw Ot(new Error("recovery backup creator missing"),t);let n;try{n=await e()}catch(a){throw a?.code===Ht?a:Ot(a,t)}if(!hn(n))throw Ot(new Error("recovery backup proof missing or unverified (download-only / memory are not durable)"),t);return n}async function ki({createRecoveryBackup:e,wipeFn:t,source:n,i18nKey:a}={}){const r=await wi(e,{source:n,i18nKey:a});if(typeof t!="function")throw new Error("wipe function missing after recovery backup");return await t(),r}function md(e){const t=e?.tables?.transactions;return Array.isArray(t)?t.filter(n=>!n?.deleted_at).length:0}const vi=Object.freeze({USER_EXPLICIT:"user_explicit_repair",USER_IMPORT_JSON:"user_import_integrity_repair",USER_RESTORE_BACKUP:"user_restore_integrity_repair"}),Xi=new Set(Object.values(vi)),Gn="straw.ledger_integrity_scan.v1",_n="straw.ledger_repair_audit.v1",Fi="LEDGER_REPAIR_DENIED";function gd(e={}){const t=String(e.reason??"").trim(),n=String(e.source??"").trim();if(!(e.confirmed===!0)||!Xi.has(t)||!n){const r=new Error("帳本修復被拒絕：缺少使用者確認。啟動／migration／orphan prune 不得靜默改寫帳本語意。");throw r.code=Fi,r.i18nKey="sqlite.error.ledger_repair_denied",r.silentRewriteBlocked=!0,r}return{reason:t,source:n,confirmed:!0}}function Ld(e={}){const t={at:String(e.at??new Date().toISOString()),ledgerId:String(e.ledgerId??""),issueCount:Number(e.issueCount??0)||0,autoRepaired:e.autoRepaired===!0,issues:e.issues&&typeof e.issues=="object"?e.issues:{}};if(typeof localStorage<"u")try{localStorage.setItem(Gn,JSON.stringify(t))}catch{}return t}function Nd(){if(typeof localStorage>"u")return null;try{const e=localStorage.getItem(Gn);return e?JSON.parse(e):null}catch{return null}}function pd(e={}){const t={at:String(e.at??new Date().toISOString()),reason:String(e.reason??""),source:String(e.source??""),ledgerId:String(e.ledgerId??""),confirmed:e.confirmed===!0,fixedCount:Number(e.fixedCount??0)||0};if(typeof localStorage<"u")try{const n=JSON.parse(localStorage.getItem(_n)||"[]"),a=Array.isArray(n)?n:[];localStorage.setItem(_n,JSON.stringify([t,...a].slice(0,jt)))}catch{}return typeof console<"u"&&typeof console.info=="function"&&console.info("[ledger-repair-audit]",t),t}const Mi=Object.freeze(["transaction_attachments","loan_payments","reimbursement_advance_usages","reimbursement_advances","reimbursement_items","reimbursements","budget_save_settlements","budget_items","budget_containers","budgets","loans","bank_transactions","bank_sync_rules","bank_accounts","bank_connections","credit_repayment_allocations","credit_repayments","transaction_postings","credit_statements","wear_applied","transactions","security_transactions","securities","savings_jars","accounts","account_groups","categories","category_groups","counterparties","app_settings","deleted_log"]),Bi=Object.freeze([...Mi.filter(e=>e!=="deleted_log"),"deleted_log","wear_sync_state","ledgers"]),Kt="SQLITE_CONSTRAINT_FOREIGNKEY",Pn=1811,jn=/foreign\s*key|SQLITE_CONSTRAINT_FOREIGNKEY|\b1811\b/i;function Hn(e){if(!e)return!1;if(e?.code===Kt||Number(e?.numericCode??e?.resultCode??e?.errno)===Pn)return!0;const t=String(e?.message??e??"");return/unique\s*constraint/i.test(t)&&!/foreign\s*key/i.test(t)?!1:/foreign\s*key/i.test(t)||/SQLITE_CONSTRAINT_FOREIGNKEY/i.test(t)||/\b1811\b/.test(t)||/constraint\s*failed/i.test(t)&&/FOREIGN KEY/i.test(t)?!0:jn.test(t)}function Kn(e=""){const t=String(e??"").trim();return t&&!jn.test(t)?t:"資料關聯不一致（外鍵約束）。請重試同步／匯入，或先修復本機資料後再操作。"}function xi(e,t={}){const n=String(e?.message??e??"").trim(),a=String(t.message??"").trim()||Kn(n),r=new Error(a);if(r.code=Kt,r.numericCode=Pn,r.i18nKey=t.i18nKey||"sqlite.error.foreign_key_constraint",r.recoverable=t.recoverable!==!1,r.originalMessage=n,e&&typeof e=="object")try{r.cause=e}catch{}return r}function Yn(e,t={}){throw!Hn(e)||e?.code===Kt&&e?.i18nKey?e:xi(e,t)}function fd(e){return Hn(e)?Kn(e?.message).slice(0,240):String(e?.message??e??"同步失敗").slice(0,240)}const Te="straw_money_book",En=1,Y=new Rn(Dn);let h=null,ue=null,xe=Te;function Gi(e){const t=String(e??"").trim();if(!t)return!1;const n=t.toUpperCase();return!(!(n.startsWith("INSERT")||n.startsWith("UPDATE")||n.startsWith("DELETE")||n.startsWith("REPLACE"))||n.includes("APP_SETTINGS"))}function Wn(){if(!(typeof window>"u"||typeof window.dispatchEvent!="function")){if(typeof CustomEvent=="function"){window.dispatchEvent(new CustomEvent("app:data-mutated"));return}window.dispatchEvent(new Event("app:data-mutated"))}}async function $n(){A.getPlatform()==="web"&&await Y.saveToStore(xe)}function ee(e){if(typeof e=="string"&&e.trim())return e;const t=e?.message;if(typeof t=="string"&&t.trim())return t;try{const n=JSON.stringify(e);if(n&&n!=="{}")return n}catch{}return"unknown sqlite error"}function Pi(e){const t=ee(e).toLowerCase();return/foreign\s*key|\b1811\b|sqlite_constraint_foreignkey/.test(t)?!1:t.includes("datatype mismatch")||t.includes("no such column")||t.includes("no such table")||t.includes("code20")||t.includes("code 20")}function ji(e){const t=ee(e).toLowerCase();return t.includes("capacitorsqliteplugin: null")||t==="null"}function Hi(e){return ee(e).toLowerCase().includes("no such table")}async function Ki(){A.getPlatform()==="web"&&await Oi()}async function Yt(){try{await Y.closeAllConnections()}catch{}}async function nt(e=xe){if((await Y.isConnection(e,!1)).result)try{h=await Y.retrieveConnection(e,!1)}catch{await Yt(),h=await Y.createConnection(e,!1,"no-encryption",En,!1)}else h=await Y.createConnection(e,!1,"no-encryption",En,!1);return await h.open(),await h.execute("PRAGMA foreign_keys = ON;"),await h.execute("PRAGMA busy_timeout = 5000;"),await Ti(h),xe=e,h}async function Yi(e=xe){if(h){try{await h.close()}catch{}h=null}if((await Y.isConnection(e,!1)).result){const n=await Y.retrieveConnection(e,!1);try{await n.close()}catch{}try{await Y.closeConnection(e,!1)}catch{}}await Yt();try{return await Y.deleteDatabase(e,!1),nt(e)}catch(n){const a=await nt(e);try{await a.execute("PRAGMA foreign_keys = ON;"),await a.execute("PRAGMA busy_timeout = 5000;");for(const r of Bi)try{await a.run(`DELETE FROM ${r};`)}catch(i){Hi(i)||Yn(i)}}catch(r){const i=ee(n),o=ee(r);throw new Error(`[sqlite] reset fallback failed; delete: ${i}; wipe: ${o}`)}return a}}async function Wi(e={}){const t=Ii(e);hi({reason:t.reason,source:t.source,confirmed:!0,note:String(e.note??"").slice(0,240)}),ii(),ue=null,xe=Te;const n=await Yi(Te);try{const{rotateWearSyncEpoch:a}=await bn(async()=>{const{rotateWearSyncEpoch:r}=await import("./wear-sync-epoch.service-BC8Np1wZ.js");return{rotateWearSyncEpoch:r}},__vite__mapDeps([0,1,2,3,4]));await a()}catch{}return n}async function qn(){return h||ue||(ue=(async()=>{const e=A.getPlatform();try{return await Ki(),await nt(Te)}catch(t){if(e==="android"&&ji(t))try{return console.warn("[sqlite] plugin null on primary open — retrying primary (recovery empty-db fallback disabled)"),await Yt(),h=null,await nt(Te)}catch(n){ue=null;let a=!1;try{a=!!(await Y.isDatabase(Te,!1))?.result}catch{a=!1}throw At(n,{message:a?`[sqlite:${e}] plugin null: primary DB file exists but cannot open (empty recovery fallback disabled): ${ee(n)}`:`[sqlite:${e}] plugin null on primary open (empty recovery fallback disabled): ${ee(n)}`})}throw ue=null,Pi(t)?At(t,{message:`[sqlite:${e}] schema integrity error (no silent wipe): ${ee(t)}`}):At(t,{message:`[sqlite:${e}] ${ee(t)}`})}})(),ue)}async function Ge(){return h||await qn(),h}let ve=!1;function $i(){const e=Bn();return!!(e&&e.depth>0&&e.status==="open")}async function Et(e,t=[]){const n=await Ge();try{const a=$i(),r=await n.run(e,t,!a);return Gi(e)&&(a?ve=!0:(await $n(),Wn())),r}catch(a){Yn(a)}}async function W(e,t=[]){return(await Ge()).query(e,t)}async function qi(e){const t=Bn();if(t&&t.status==="open"){t.depth+=1;try{const n=await Ge();return await e(n,t)}finally{t.depth=Math.max(0,t.depth-1)}}return pi.enqueue(async()=>{const n=gi();n.depth=1,ve=!1;const a=await Ge();await a.beginTransaction();try{const r=await Li(n,async()=>e(a,n));return n.status="committing",await a.commitTransaction(),n.status="committed",ve&&(await $n(),Wn()),ve=!1,r}catch(r){n.status="rolling_back";try{await a.rollbackTransaction()}catch{}throw n.status="rolled_back",ve=!1,r}finally{n.depth=0}})}const Ad=Object.freeze(Object.defineProperty({__proto__:null,PRIMARY_DB_NAME:Te,getDatabase:Ge,initDatabase:qn,query:W,resetDatabase:Wi,run:Et,withTransaction:qi},Symbol.toStringTag,{value:"Module"}));function Od(e=""){const t=Date.now().toString(36),n=Math.random().toString(36).slice(2,10);return e?`${e}_${t}_${n}`:`${t}_${n}`}function zn(){return new Date().toISOString()}function Sd(e=new Date){const t=typeof e=="string"?new Date(e):e,n=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0");return`${n}-${a}`}function Rd(e=new Date){const t=typeof e=="string"?new Date(e):e,n=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0");return`${n}-${a}-${r}`}function bd(e){if(!e)throw new Error("ledgerId is required")}function zi(e){return e?.values??[]}function Vi(e){return zi(e)[0]??null}async function Vn(e,t){const n=await W(`SELECT value_json
     FROM app_settings
     WHERE ledger_id = ? AND key = ?
     LIMIT 1;`,[e,t]),a=Vi(n);if(!a)return null;try{return JSON.parse(a.value_json)}catch{return null}}async function rt(e,t,n){await Et(`INSERT INTO app_settings (ledger_id, key, value_json, updated_at)
     VALUES (?, ?, ?, ?)
     ON CONFLICT(ledger_id, key)
     DO UPDATE SET value_json = excluded.value_json, updated_at = excluded.updated_at;`,[e,t,JSON.stringify(n),zn()])}async function Ji(e,t){await Et(`DELETE FROM app_settings
     WHERE ledger_id = ? AND key = ?;`,[e,t])}async function Zi(e){const t=await W(`SELECT key, value_json, updated_at
     FROM app_settings
     WHERE ledger_id = ?;`,[e]);return Array.isArray(t?.values)?t.values:[]}async function Qi(e,t={}){await Et(`INSERT INTO app_settings (ledger_id, key, value_json, updated_at)
     VALUES (?, ?, ?, ?)
     ON CONFLICT(ledger_id, key)
     DO UPDATE SET value_json = excluded.value_json, updated_at = excluded.updated_at;`,[e,String(t?.key??"").trim(),String(t?.value_json??"null"),String(t?.updated_at??"").trim()||zn()])}const Dd=Object.freeze(Object.defineProperty({__proto__:null,getSetting:Vn,listAppSettingRows:Zi,removeSetting:Ji,setSetting:rt,upsertAppSettingRow:Qi},Symbol.toStringTag,{value:"Module"}));function Pe(e){const t=Number(e);if(!Number.isFinite(t))throw new Error("amountMinor 必須為有效數字");return Math.round(t)}function yd(e){return Math.abs(Pe(e))}function Id(e){const t=Pe(e);return t===0?0:-t}function Cd(e){const t=Number(e);if(!Number.isInteger(t)||t<0)throw new Error("amountMinor 必須為大於或等於 0 的數字");return t}function Ud(e){const t=Number(e);if(!Number.isInteger(t)||t<=0)throw new Error("amountMinor 必須為大於 0 的數字");return t}function hd(e){const t=Number(e);if(!Number.isFinite(t)||t===0)throw new Error("adjustment amountMinor 不能為 0");return t}function eo(e){return Pe(e??0)}function wd(e=[]){const t=Array.isArray(e)?e:[];let n=0;for(const a of t){const r=Math.round(Number(a?.remaining_minor??a?.remainingMinor??0));!Number.isFinite(r)||r<=0||(n+=r)}return n}function to(e,t){return Pe(e??0)+Pe(t??0)}function Jn(e="rt",t="rc"){return`(
        ${e}.origin_type = 'refund'
        OR ${t}.name = '退款'
        OR ${e}.note LIKE '退款：%'
        OR ${e}.note LIKE '退款:%'
      )`}function no(e="t"){return`EXISTS (
    SELECT 1
    ...
    WHERE rt.ledger_id = ${e}.ledger_id
      ...
      AND ${Jn("rt","rc")}
  )`}function ro(e="t"){return`COALESCE((
    ...
    WHERE rt.ledger_id = ${e}.ledger_id
      ...
      AND rt.external_ref_id = ${e}.id
      AND ${Jn("rt","rc")}
  ), 0)`}const ao={BASE_URL:"/app/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_BANK_SYNC_ENABLE_UNSUPPORTED_REAL_PROVIDERS:"true",VITE_BANK_SYNC_FEATURE_ENABLED:"true",VITE_EINVOICE_CLIENT_SHARED_KEY:"bdf6d030f54e8b6da78d5b457f6987206493812e7ae7a8139dbbdadf603ef7c0",VITE_GOOGLE_USE_SERVER_AUTH_CODE:"true",VITE_GOOGLE_WEB_CLIENT_ID:"110585924943-419l5kajjdao1c7jktsg64v4k64qh5o0.apps.googleusercontent.com",VITE_PRIVACY_POLICY_URL:"https://www.strawmb.com/privacy-policy",VITE_WEB_HASH_ROUTER:"true"},io=["VITE_GOOGLE_WEB_CLIENT_ID","VITE_GOOGLE_OAUTH_CLIENT_ID","VITE_GOOGLE_CLIENT_ID"];function Zn(){for(const e of io){const t=String(ao[e]??"").trim();if(t)return t}return""}function ht(){return In("settings_account.google_client_id_missing","缺少 Google Web Client ID（請設定 VITE_GOOGLE_WEB_CLIENT_ID）")}const oo="https://www.googleapis.com/auth/drive.appdata",so=["email","profile",oo],Wt="straw.google.oauth.token_cache.v1",co=60*1e3,et=120*1e3,Qn=20*1e3,_o=8*1e3,Eo=3300,uo=et+Qn+15*1e3,St="Google 登入逾時，請重試",lo="Google 授權交換逾時，請檢查網路後重試",er="https://api.strawmb.com",To=go("true"),$t=Lo(),un=No(),ln=nr(void 0,"/api/google/oauth/exchange"),Tn=nr(void 0,"/api/google/oauth/refresh"),mn="".trim();let gn="",at="",je="",ne="",oe=0,$="",F=null,Ne=null,Ve=0,Je=!1;const mo="GOOGLE_REAUTH_REQUIRED",Ln="Google 登入成功但未取得長效 refresh token，無法用於自動備份";function go(e){const t=String(e).trim().toLowerCase();return t==="1"||t==="true"||t==="yes"||t==="on"}function He(){return $t?je!=="online":!1}function tr(){if(!$t)throw new Error("Google 自動備份需要長效授權，但目前未啟用 server auth code flow");je==="online"&&(je="",at="",lt())}function Lo(){if(!To)return!1;if(!A.isNativePlatform())return!0;const e="".trim(),t="".trim(),n="".trim(),a=le(t)&&le(n),r=le(e);return a||r||le(er)?!0:(console.warn("[google-auth] VITE_GOOGLE_USE_SERVER_AUTH_CODE=true but no explicit Google OAuth backend is configured for native runtime; fallback to online mode."),!1)}function le(e){return/^https?:\/\//i.test(String(e??"").trim())}function No(){const e="".trim();return le(e)?e.replace(/\/+$/,""):er}function po(){if(A.isNativePlatform()||le("".trim()))return!0;if(typeof window<"u"){const e=String(window.location?.origin??"").trim();if(/^https?:\/\/(?:127\.0\.0\.1|localhost)(?::\d+)?$/i.test(e))return!1}return!0}function nr(e,t){const n="".trim()||String(t??"").trim();if(!n)return"";if(le(n)||!n.startsWith("/")||!po())return n;try{return new URL(n,`${un}/`).toString()}catch{return`${un}${n}`}}function Rt(e,t,n){let a=0;const r=new Promise((i,o)=>{a=globalThis.setTimeout(()=>{o(new Error(n))},t)});return Promise.race([e,r]).finally(()=>{a&&globalThis.clearTimeout(a)})}async function rr(e,t,n,a){const r=typeof AbortController=="function"?new AbortController:null;let i=0;r&&Number.isFinite(n)&&n>0&&(i=globalThis.setTimeout(()=>{r.abort()},n));try{return await fetch(e,{...t??{},...r?{signal:r.signal}:{}})}catch(o){throw r?.signal?.aborted?new Error(a):o}finally{i&&globalThis.clearTimeout(i)}}function fo(){if(!A.isNativePlatform())throw new Error("Google 備份僅支援 App 裝置")}function Ke(e){return e?typeof e=="string"?e:String(e.token??"").trim():""}function de(e){const t=e&&typeof e=="object"?e:{};return{email:String(t.email??"").trim(),name:String(t.name??"").trim(),imageUrl:String(t.imageUrl??t.picture??"").trim()}}function ar(){return!ne||!Number.isFinite(oe)||oe<=0?!1:Date.now()+co<oe}function qt(){return typeof localStorage<"u"}function Ie(){if(!qt())return;const e={accessToken:ne,accessTokenExpiresAtMs:oe,refreshToken:$,profile:F,mode:ir()};try{localStorage.setItem(Wt,JSON.stringify(e))}catch{}}function Ao(){if(qt())try{const e=localStorage.getItem(Wt);if(!e)return;const t=JSON.parse(e);if(!t||typeof t!="object")return;ne=Ke(t.accessToken),$=String(t.refreshToken??"").trim(),oe=Math.max(0,Number(t.accessTokenExpiresAtMs??0)||0),F=de(t.profile)}catch{}}function Oo(){if(qt())try{localStorage.removeItem(Wt)}catch{}}function ut({accessToken:e,refreshToken:t,expiresInSec:n,expiresAtMs:a}={}){typeof e=="string"&&(ne=e.trim()),typeof t=="string"&&($=t.trim());const r=Number(a);if(Number.isFinite(r)&&r>0)oe=r;else{const i=Number(n);oe=Number.isFinite(i)&&i>0?Date.now()+i*1e3:0}Ie()}function lt({keepRefreshToken:e=!1}={}){ne="",oe=0,e||($=""),e?Ie():Oo()}function So(){return"".trim()}function Ro(){return Zn()}function ir(){return He()?"offline":"online"}function or(e){const t=String(e?.message??e??"").toLowerCase();return t.includes("account reauth failed")||t.includes("[16]")}function bo(e){const t=[],n=String(e?.code??e?.errorCode??"").trim(),a=String(e?.status??"").trim(),r=String(e?.name??"").trim(),i=String(e?.message??e??"").trim();return n&&t.push(`code=${n}`),a&&t.push(`status=${a}`),r&&r!=="Error"&&t.push(`name=${r}`),i&&t.push(`raw=${i}`),t}function Ae(e,t){const n=bo(t);return n.length?`${e}（${n.join(" | ")}）`:e}function Oe(e){if(or(e))return new Error(Ae("Google 需要重新授權，請再試一次；若仍失敗請先在裝置 Google 帳號中移除本 App 授權後重登。",e));const t=String(e?.message??"").trim(),n=t.toLowerCase();return n.includes("missing_google_oauth_env")||n.includes("google_exchange_004")||n.includes("google_refresh_004")||n.includes("google_oauth_client_secret")||n.includes("invalid_client")||n.includes("client secret is invalid")?new Error(Ae("Google 自動備份後端設定錯誤，請通知管理員檢查 Google OAuth client / secret 設定。",e)):n.includes("invalid_grant")||n.includes("redirect_uri_mismatch")||n.includes("code was already redeemed")?new Error(Ae("Google 授權碼已失效或無法交換，請到自動備份頁重新登入 Google。",e)):new Error(Ae(t||"Google 登入失敗",e))}function tt(e="Google 需要重新授權，請到自動備份頁重新登入 Google。",t=null){const n=new Error(Ae(e,t));return n.code=mo,n}function sr(e){const t=e&&typeof e=="object"?e:{},n=Ke(t.accessToken??t.access_token);if(!n)throw new Error("後端未回傳 access token");const a=t.refreshToken??t.refresh_token,r=typeof a=="string"?a.trim():"",i=Number(t.expiresIn??t.expires_in??0),o=Number.isFinite(i)&&i>0?i:0,s=Number(t.accessTokenExpiresAtMs??t.access_token_expires_at_ms??t.expiresAtMs??0),c=Number.isFinite(s)&&s>0?s:0,d=de(t.profile),E=de(t),u=d.email||d.name||d.imageUrl?d:E;return t.idToken??t.id_token,{accessToken:n,refreshToken:r,expiresInSec:o,expiresAtMs:c,profile:u}}async function dr(e,t){const n={"Content-Type":"application/json"};mn&&(n["X-Straw-Client-Key"]=mn);let a;try{a=await rr(e,{method:"POST",headers:n,body:JSON.stringify(t??{})},Qn,lo)}catch(o){throw new Error(Ae(`Google OAuth 請求失敗（url=${e}）`,o))}const r=await a.text();let i=null;if(r)try{i=JSON.parse(r)}catch{i=null}if(!a.ok){const o=String(i?.message??i?.error_description??r??i?.error??"").trim(),s=String(i?.errorNumber??"").trim(),c=s?`（errorNumber=${s}）`:"";throw new Error(`${o||`HTTP ${a.status}`}${c}（url=${e}）`)}if(!i||typeof i!="object")throw new Error(`後端回應格式錯誤（url=${e}）`);return i}async function cr(e){if(!e)return null;try{const t=await rr("https://openidconnect.googleapis.com/v1/userinfo",{method:"GET",headers:{Authorization:`Bearer ${e}`}},_o,"Google 使用者資料讀取逾時");if(!t.ok)return null;const n=await t.json(),a=de(n);return!a.email&&!a.name&&!a.imageUrl?null:a}catch{return null}}async function Do(e){const t=String(e??"").trim();if(!t)throw new Error("Google 登入成功但未取得 server auth code");if(!ln)throw new Error("缺少 Google OAuth 後端交換端點（請設定 VITE_GOOGLE_OAUTH_EXCHANGE_URL）");const n=await dr(ln,{serverAuthCode:t});return console.info("[google-auth] exchangeServerAuthCode success"),sr(n)}async function yo(e){const t=String(e??"").trim();if(!t)throw tt("Google 授權已失效，請到自動備份頁重新登入 Google。");if(!Tn)throw new Error("缺少 Google OAuth 後端 refresh 端點（請設定 VITE_GOOGLE_OAUTH_REFRESH_URL）");const n=await dr(Tn,{refreshToken:t});return n?.accessToken??n?.access_token,sr(n)}async function bt(e={}){const t=String(e.preferredEmail??e.loginHint??"").trim(),n={scopes:so,...e};return delete n.preferredEmail,t&&!n.loginHint&&(n.loginHint=t),Se.login({provider:"google",options:n})}function Io(e=""){je!=="online"&&(je="online",at="",lt(),e&&console.warn("[google-auth] switch to online mode fallback",e))}function Co(e){return de({email:e?.profile?.email||"",name:e?.profile?.name||"",imageUrl:e?.profile?.imageUrl||""})}function _r(e){const t=e&&typeof e=="object"?e:{},n=Number(t.expiresAtMs??t.expires_at_ms??t.expireTimeMs??t.expirationTimeMs??0);if(Number.isFinite(n)&&n>Date.now()){const r=Math.floor((n-Date.now())/1e3);if(r>0)return r}const a=Number(t.expiresIn??t.expires_in??t.expires??0);return Number.isFinite(a)&&a>0?a:Eo}async function Uo(){if(!(await Se.isLoggedIn({provider:"google"}))?.isLoggedIn)return"";const t=await Se.getAuthorizationCode({provider:"google"}),n=Ke(t?.accessToken);if(!n)return"";ut({accessToken:n,refreshToken:"",expiresInSec:_r(t)});const a=de(t?.profile);return(a.email||a.name||a.imageUrl)&&(F=a,Ie()),ne}function Nn(e){const t=Ke(e?.accessToken);if(!t)throw new Error("Google 登入成功但未取得 access token");return ut({accessToken:t,refreshToken:"",expiresInSec:_r(e)}),F=Co(e),Ie(),{accessToken:t,profile:F}}async function wt(){fo();const e=Ro();if(!e)throw new Error(ht());const t=ir();if(gn===e&&at===t)return;const n={webClientId:e,mode:t},a=So();a&&(n.iOSClientId=a),t==="offline"&&(n.iOSServerClientId=e),await Se.initialize({google:n}),gn=e,at=t}async function kt(e={}){const t=!!e?.requireRefreshToken;if(Ne){const a=Date.now()-Ve;if(a>=0&&a<uo){if(!t||Je)return Ne;console.warn("[google-auth] refresh-token sign-in cannot reuse an online-only sign-in promise")}else console.warn("[google-auth] stale sign-in promise detected, forcing a fresh login attempt",{elapsedMs:a});Ne=null,Ve=0,Je=!1}Ve=Date.now(),Je=t;const n=(async()=>{t&&tr(),await wt();let a;try{a=await Rt(bt({forceRefreshToken:!0,filterByAuthorizedAccounts:!1,style:He()?"standard":"bottom",preferredEmail:e.preferredEmail}),et,St)}catch(r){if(or(r)){try{await Se.logout({provider:"google"})}catch{}try{a=await Rt(bt({forceRefreshToken:!0,filterByAuthorizedAccounts:!1,forcePrompt:!0,style:"standard",preferredEmail:e.preferredEmail}),et,St)}catch(i){throw Oe(new Error(`首次登入失敗：${String(r?.message??r)}；重試仍失敗：${String(i?.message??i)}`))}}else throw Oe(r)}if(a.provider!=="google")throw new Error("Google 登入失敗，請重試");if(He())try{if(a.result?.responseType!=="offline")throw new Error("Google 登入成功但未取得 server auth code");const r=await Do(a.result.serverAuthCode),i=r.accessToken;if(t&&!r.refreshToken)throw new Error(Ln);const o=r.refreshToken||$,s=r.profile,c=s.email||s.name||s.imageUrl?s:await cr(i);return ut({accessToken:i,refreshToken:o,expiresInSec:r.expiresInSec,expiresAtMs:r.expiresAtMs}),F=de(c),Ie(),{accessToken:ne,profile:F}}catch(r){if(t)throw Oe(r);console.warn("[google-auth] offline auth flow failed, fallback to online mode",r),Io(String(r?.message??r)),await wt();let i=a;if((i.result?.responseType!=="online"||!Ke(i.result?.accessToken))&&(i=await Rt(bt({forceRefreshToken:!0,filterByAuthorizedAccounts:!1,forcePrompt:!0,style:"standard",preferredEmail:e.preferredEmail}),et,St)),i.result?.responseType!=="online")throw Oe(r);return Nn(i.result)}if(t)throw new Error(Ln);if(a.result?.responseType!=="online")throw new Error("Google 登入失敗，請重試");return Nn(a.result)})();Ne=n;try{return await n}finally{Ne===n&&(Ne=null,Ve=0,Je=!1)}}async function Ce(e={}){const t=!!e?.requireRefreshToken;if(t&&tr(),ar()&&(!t||$))return ne;const n=e?.interactive!==!1,a=String(e?.preferredEmail??"").trim();if(He()){if($)try{const r=await yo($);if(ut({accessToken:r.accessToken,refreshToken:r.refreshToken||$,expiresInSec:r.expiresInSec,expiresAtMs:r.expiresAtMs}),!F?.email){const i=r.profile.email||r.profile.name||r.profile.imageUrl?r.profile:await cr(r.accessToken);i&&(F=de(i),Ie())}return ne}catch(r){console.warn("[google-auth] backend refresh failed",r)}if(n)try{return(await kt({preferredEmail:a,requireRefreshToken:t})).accessToken}catch(r){throw Oe(r)}throw tt()}await wt();try{const r=await Uo();if(r)return r}catch(r){if(!n)throw console.warn("[google-auth] background token fetch failed",r),tt(void 0,r);console.warn("[google-auth] silent token fetch before interactive sign-in failed",r)}if(n)try{return(await kt({preferredEmail:a,requireRefreshToken:t})).accessToken}catch(r){throw Oe(r)}throw tt()}async function Er(e={}){const t=e?.interactive!==!1;return lt({keepRefreshToken:He()}),Ce({interactive:t,requireRefreshToken:!!e?.requireRefreshToken})}async function ho(){try{await Se.logout({provider:"google"})}catch(e){if(!$t||!String(e?.message??"").toLowerCase().includes("offline mode"))throw e}finally{lt(),F=null}}function Re(){return F}function ur(){const e=F&&typeof F=="object"?F:{};return!!($||ar()||e.email||e.name||e.imageUrl)}Ao();const wo=yn("FileOpener"),ko="StrawMoneyBook",lr=["account_groups","accounts","category_groups","categories","transactions","wear_applied","transaction_attachments","counterparties","loans","loan_payments","reimbursement_advances","reimbursement_advance_usages","reimbursements","reimbursement_items","budget_save_settlements","budgets","budget_containers","budget_items","savings_jars","securities","security_transactions","credit_statements","credit_repayments","credit_repayment_allocations","transaction_postings","bank_connections","bank_accounts","bank_transactions","bank_sync_rules","app_settings","deleted_log"],vo=/(password|token|secret|authorization|client[_-]?key)/i,Xo=/^(?:bank_sync\.credentials\.[^.]+|backup\.webdav\.credentials)$/i,vt="【附加項目】";function Fo(e){if(e==null)return"";const t=String(e);return t.includes(",")||t.includes('"')||t.includes(`
`)?`"${t.replaceAll('"','""')}"`:t}function Ye(e,t=null){const n=Array.isArray(t)&&t.length?t:Object.keys(e[0]??{});if(!n.length)return"";const a=[n.join(",")];for(const r of e)a.push(n.map(i=>Fo(r[i])).join(","));return a.join(`\r
`)}function it(e){if(Array.isArray(e))return e.map(n=>it(n));if(!e||typeof e!="object")return e;const t={};for(const[n,a]of Object.entries(e))t[n]=vo.test(n)?"":it(a);return t}function Mo(e){if(!e||typeof e!="object")return e;const t=String(e.key??"").trim();if(Xo.test(t))return null;try{const n=JSON.parse(String(e.value_json??"null"));return!n||typeof n!="object"?e:t==="backup.webdav"?{...e,value_json:JSON.stringify({...it(n),connected:!1,autoEnabled:!1,dataChangeAutoEnabled:!1,password:"",lastError:""})}:{...e,value_json:JSON.stringify(it(n))}}catch{return e}}function Tr(e){const t=String(e??"").split(`
`).map(n=>n.trim()).find(n=>n.startsWith(vt));return t?t.slice(vt.length).trim():""}function mr(e){return String(e??"").split(`
`).map(t=>t.trim()).filter(t=>t&&!t.startsWith(vt)).join(`
`)}function Bo(e){const[t,n]=String(e??"").split("-").map(i=>Number(i)),a=new Date(t,n-1,1,0,0,0),r=new Date(t,n,1,0,0,0);return{startUtc:a.toISOString(),endUtc:r.toISOString()}}function xo(e){const t=Number(e),n=new Date(t,0,1,0,0,0),a=new Date(t+1,0,1,0,0,0);return{startUtc:n.toISOString(),endUtc:a.toISOString()}}function Go(e){const[t,n,a]=String(e??"").split("-").map(o=>Number(o)),r=new Date(t,n-1,a,0,0,0),i=new Date(t,n-1,a+1,0,0,0);return{startUtc:r.toISOString(),endUtc:i.toISOString()}}function Po(e,t){const[n,a,r]=String(e??"").split("-").map(E=>Number(E)),[i,o,s]=String(t??"").split("-").map(E=>Number(E)),c=new Date(n,a-1,r,0,0,0),d=new Date(i,o-1,s+1,0,0,0);return{startUtc:c.toISOString(),endUtc:d.toISOString()}}function gr(e=new Date){const t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0"),r=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),o=String(e.getSeconds()).padStart(2,"0");return`${t}-${n}-${a}_${r}${i}${o}`}function Xt(e,t="ledger"){const n=String(e??"").replace(/[\\/:*?"<>|]/g,"_").replace(/\s+/g,"_").replace(/_+/g,"_").replace(/^_+|_+$/g,"");return n?Array.from(n).slice(0,40).join(""):t}function jo(e,t={}){return e==="year"?xo(t.yearKey):e==="month"?Bo(t.monthKey):e==="day"?Go(t.dayKey):e==="custom"?Po(t.startDate,t.endDate):{startUtc:null,endUtc:null}}const Ho=["類型","記帳時間","交易帳戶","交易帳本","貨幣符號","交易金額","當期帳戶餘額","一級分類","二級分類","交易標籤","備註","附加項目","退款&轉銷","收回","歸還","匯率"],Ko=Ho.filter(e=>e!=="交易標籤");function pn(e){const t=String(e??"").trim();return t?t.split(/\s*(?:-->|->|→|＞)\s*/g).map(n=>n.trim()).filter(Boolean):[]}function Yo(e,t){const n=pn(e),a=pn(t),r=n[0]||a[0]||"";let i="";return a.length>1?i=a.slice(1).join(" / "):a.length===1?i=a[0]:n.length>1&&(i=n.slice(1).join(" / ")),{primary:r,secondary:i}}async function Tt(e,t){const a=(await W(`SELECT * FROM ${t} WHERE ledger_id = ?;`,[e]))?.values??[];return t!=="app_settings"?a:a.map(r=>Mo(r)).filter(Boolean)}async function Lr(){const e=await W("SELECT MAX(version) AS version FROM schema_migrations;");return Number(e?.values?.[0]?.version??0)}async function Wo(e,t=null){const n=!!t,a=n?`SELECT
         a.id AS account_id,
       ...
       FROM accounts a
       WHERE a.ledger_id = ?
       GROUP BY a.id, a.opening_balance_minor;`,i=(n?await W(a,[t,e]):await W(a,[e]))?.values??[],o=new Map;for(const s of i)o.set(String(s.account_id),eo(s.balance_minor));return o}async function kd(e){const t={schema_version:0,exported_at:new Date().toISOString(),ledger_id:e,tables:{}};t.schema_version=await Lr();const n=await W("SELECT * FROM ledgers WHERE id = ?;",[e]);t.tables.ledgers=n?.values??[];for(const a of lr)t.tables[a]=await Tt(e,a);return t}async function Nr(){const e={schema_version:await Lr(),exported_at:new Date().toISOString(),backup_scope:"all_ledgers",ledgers:[]},n=(await W("SELECT * FROM ledgers WHERE deleted_at IS NULL ORDER BY sort_order ASC, created_at ASC, id ASC;"))?.values??[];for(const a of n){const r=a?.id;if(!r)continue;const i={schema_version:e.schema_version,exported_at:e.exported_at,ledger_id:r,tables:{ledgers:[a]}};for(const o of lr)i.tables[o]=await Tt(r,o);e.ledgers.push(i)}return e}async function vd(e){const n=((await W(`SELECT *
     FROM transactions
     WHERE ledger_id = ?
       AND deleted_at IS NULL
     ORDER BY occurred_at DESC, created_at DESC;`,[e]))?.values??[]).map(r=>({...r,note_without_addon:mr(r.note),addon_items:Tr(r.note)})),a=n.length?Object.keys(n[0]):["ledger_id","id","type","transfer_group_id","account_id","peer_account_id","category_id","amount_minor","occurred_at","note","location","tags_json","origin_type","external_ref_id","idempotency_key","is_reimbursable","reimbursement_state","reimbursed_at","note_without_addon","addon_items","created_at","updated_at","deleted_at"];return Ye(n,a)}async function Xd(e){const t=await Tt(e,"accounts");return Ye(t)}async function Fd(e){const t=await Tt(e,"categories");return Ye(t)}function $o(e){return e==="expense"?"支出":e==="income"?"收入":e==="transfer"?"轉帳":"調整"}function qo(e){if(Array.isArray(e))return e.map(n=>String(n??"").trim()).filter(Boolean).join("、");const t=String(e??"").trim();if(!t)return"";try{const n=JSON.parse(t);if(Array.isArray(n))return n.map(a=>String(a??"").trim()).filter(Boolean).join("、")}catch{}return t}function zo(e,t){const n=[],a=[];for(const r of e){const i=Number(r.amount_minor??0)/100,o=String(r.account_id??""),s=to(t.get(o),r.amount_minor);t.set(o,s);const c=s/100,d=Yo(r.category_group_name,r.category_name),E=Tr(r.note),u={類型:$o(r.type),記帳時間:r.occurred_at??"",交易帳戶:r.account_name??"",交易帳本:r.ledger_name??"",貨幣符號:r.currency_code??"TWD",交易金額:String(i),當期帳戶餘額:String(c),一級分類:d.primary,二級分類:d.secondary,備註:mr(r.note),附加項目:E,"退款&轉銷":"",收回:"",歸還:"",匯率:"1"};n.push(u),a.push({...u,交易標籤:qo(r.tags_json)})}return{csvRows:n,excelRows:a}}async function Vo(e,t={}){const n=["all","year","month","day","custom"].includes(t.mode)?t.mode:"all",{startUtc:a,endUtc:r}=jo(n,t),i=await Wo(e,a),o=[e];let s="";a&&r&&(s=" AND t.occurred_at >= ? AND t.occurred_at < ?",o.push(a,r));const d=(await W(`SELECT
       t.type,
       t.account_id,
       t.category_id,
       t.include_in_analysis,
       CASE WHEN ${no("t")} THEN 1 ELSE 0 END AS has_refund_link,
       ${ro("t")} AS refund_deducted_minor,
       t.occurred_at,
       t.note,
       t.tags_json,
       t.origin_type,
     ...
     WHERE t.ledger_id = ?
       AND t.deleted_at IS NULL
       ${s}
     ORDER BY t.occurred_at ASC, t.created_at ASC;`,o))?.values??[],{csvRows:E,excelRows:u}=zo(d,i),T=E[0]?.交易帳本||d[0]?.ledger_name||"ledger";return{mode:n,ledgerName:T,rowCount:E.length,csvRows:E,excelRows:u,records:d}}async function Md(e,t={}){const n=await Vo(e,t),r=`${Xt(n.ledgerName)}_transactions_${n.mode}_${gr()}.csv`,i=Ye(n.csvRows,Ko);return{filename:r,csvText:i,rowCount:n.rowCount}}function Ze(e){const t=Number(e??0)/100;return Number.isFinite(t)?t.toFixed(2).replace(/\.00$/,"").replace(/(\.\d)0$/,"$1"):"0"}function Jo(e){const t=String(e??"").trim();return{active:"進行中",partial:"部分完成",settled:"已結清",void:"完成"}[t]??t}function Zo(e){return e==="borrow"?"借入":"借出"}const Qo=["狀態","借貸方向","對象名稱","開始日期","到期日","建立入帳帳戶","本金","預設利息","已收 / 已還","剩餘","備註"];function es(e=[]){return(e??[]).map(t=>({狀態:Jo(t?.status),借貸方向:Zo(t?.direction),對象名稱:String(t?.counterparty_name??"").trim()||"未命名對象",開始日期:String(t?.start_date??t?.setup_occurred_at??"").trim(),到期日:String(t?.due_date??"").trim(),建立入帳帳戶:String(t?.setup_account_name??"").trim(),本金:Ze(t?.principal_minor),預設利息:Ze(t?.preset_interest_minor),"已收 / 已還":Ze(t?.paid_minor),剩餘:Ze(t?.remaining_minor),備註:String(t?.note??"").trim()}))}function Bd(e,t={}){const n=Xt(t.ledgerName??"loans"),a=Xt(t.scopeName??""),r=t.tab==="borrow"?"borrow":"lend",i=t.showFinished?"finished":"active",o=gr(t.now instanceof Date?t.now:new Date),s=es(e),c=a?`_${a}`:"";return{filename:`${n}_loans${c}_${r}_${i}_${o}.csv`,csvText:Ye(s,Qo),rowCount:s.length}}function xd(e,t){const n=new Blob([JSON.stringify(t,null,2)],{type:"application/json"});pr(e,n)}function Gd(e,t){const n=new Blob([`\uFEFF${t}`],{type:"text/csv;charset=utf-8"});pr(e,n)}function Pd(e){const t=new Blob([`\uFEFF${e}`],{type:"text/csv;charset=utf-8"});return URL.createObjectURL(t)}function jd(e){const t=e instanceof Blob?e:new Blob([e],{type:"application/pdf"});return URL.createObjectURL(t)}function Hd(e){e&&URL.revokeObjectURL(e)}function ts(e,t){if(!e)return;const n=document.createElement("a");n.href=e,n.download=t,document.body.appendChild(n),n.click(),n.remove()}function Kd(e){const t=String(e??"").trim();if(!t||typeof window>"u"||typeof document>"u")return!1;const n=t.startsWith("blob:")||t.startsWith("data:"),a=/^file:\/\//i.test(t)||/^content:\/\//i.test(t)||t.startsWith("/");if(A.isNativePlatform()){if(n)return!1;if(a)return wo.openFile({uri:t}).catch(i=>{console.warn("[file-opener] failed to open exported file",i)}),!0;try{return window.location.assign(t),!0}catch{}}const r=()=>{const i=document.createElement("a");return i.href=t,i.target="_blank",i.rel="noopener noreferrer",document.body.appendChild(i),i.click(),i.remove(),!0};try{if(window.open(t,"_blank","noopener,noreferrer"))return!0}catch{}try{return r()}catch{try{return window.location.assign(t),!0}catch{return!1}}}function pr(e,t){const n=URL.createObjectURL(t);ts(n,e),URL.revokeObjectURL(n)}function fr(e){const t=new TextEncoder().encode(e),n=32768;let a="";for(let r=0;r<t.length;r+=n)a+=String.fromCharCode(...t.subarray(r,r+n));return btoa(a)}function ns(e){const t=e instanceof Uint8Array?e:e instanceof ArrayBuffer?new Uint8Array(e):new Uint8Array(e??[]),n=32768;let a="";for(let r=0;r<t.length;r+=n)a+=String.fromCharCode(...t.subarray(r,r+n));return btoa(a)}async function zt(e,t,n={}){if(!A.isNativePlatform())return{saved:!1,reason:"not-native"};const a=rs(e),r=as(n.category,"exports"),i=`${ko}/${r}/${a}`,o=`Documents/${i}`,s=[{directory:an.Documents,path:i,location:o},{directory:an.ExternalStorage,path:o,location:o}].filter(d=>!!d.directory);let c=null;for(const d of s)try{const E=await Yr.writeFile({path:d.path,data:t,directory:d.directory,recursive:!0});return{saved:!0,uri:E?.uri??"",openUrl:E?.uri?A.convertFileSrc(E.uri):"",filename:a,location:d.location}}catch(E){c=E}return{saved:!1,reason:c?.message??"write-failed"}}function rs(e){const t=String(e??"").trim(),n=`export_${Date.now()}.csv`;if(!t)return n;const i=(t.includes(".")?t:`${t}.csv`).normalize("NFKD").replace(/[\u0300-\u036f]/g,"").replace(/[^\w.-]+/g,"_").replace(/_+/g,"_").replace(/^_+|_+$/g,"").slice(0,80);return i||n}function as(e,t="exports"){return String(e??"").trim().normalize("NFKD").replace(/[\u0300-\u036f]/g,"").replace(/[^\w.-]+/g,"_").replace(/_+/g,"_").replace(/^_+|_+$/g,"").toLowerCase()||t}async function Yd(e,t,n={}){const a=JSON.stringify(t,null,2),r=fr(a);return zt(e,r,n)}async function Wd(e,t,n={}){const a=fr(`\uFEFF${t}`);return zt(e,a,n)}async function $d(e,t,n={}){const a=t instanceof Blob?await t.arrayBuffer():t,r=ns(a);return zt(e,r,n)}function Ar(e){return Math.max(1,Number(e??24)||24)}function is(e,t=Date.now()){if(!e?.connected||!e?.autoEnabled)return!1;const n=String(e?.lastBackupAt??"").trim();if(!n)return!0;const a=Date.parse(n);if(!Number.isFinite(a))return!0;const r=Ar(e?.intervalHours)*60*60*1e3;return t-a>=r}const be="https://www.googleapis.com/drive/v3/files",Or="https://www.googleapis.com/upload/drive/v3/files";function _e(e,t={}){const n=os(t);return delete n.Authorization,delete n.authorization,{...n,Authorization:`Bearer ${e}`}}function os(e){return e?Array.isArray(e)?Object.fromEntries(e):typeof e.entries=="function"?Object.fromEntries(Array.from(e.entries())):typeof e=="object"?{...e}:{}:{}}async function me(e,t,n,a){const r=await fetch(n,a);if(r.status!==401||typeof t!="function")return r;const i=await t();return fetch(n,{...a,headers:_e(i,a?.headers??{})})}function ge(e,t){return e.ok?e:e.text().then(n=>{throw new Error(`${t}：${n||e.status}`)})}function ss(e,t){const n=`strawmoneybook_${Math.random().toString(16).slice(2)}`,a=`\r
--${n}\r
`,r=`\r
...
\r
`,t,r]),contentType:`multipart/related; boundary=${n}`}}async function ds(e,t,n){const a=encodeURIComponent(`name='${n}' and 'appDataFolder' in parents and trashed=false`),r=encodeURIComponent("files(id,name,modifiedTime,size)"),i=`${be}?spaces=appDataFolder&q=${a}&fields=${r}&orderBy=modifiedTime desc`,o=await me(e,t,i,{method:"GET",headers:_e(e)});await ge(o,"讀取 Google 備份清單失敗");const s=await o.json();return Array.isArray(s?.files)?s.files:[]}async function cs(e,t,n){const a=`${be}/${encodeURIComponent(n)}`,r=await me(e,t,a,{method:"DELETE",headers:_e(e)});await ge(r,"刪除重複備份失敗")}async function _s(e,t,n,a){const r={name:n,parents:["appDataFolder"]},{body:i,contentType:o}=ss(r,a),s=await me(e,t,`${Or}?uploadType=multipart&fields=id,name,modifiedTime`,{method:"POST",headers:_e(e,{"Content-Type":o}),body:i});return await ge(s,"建立 Google 備份失敗"),s.json()}async function Es(e,t,n,a){const r=await me(e,t,`${Or}/${encodeURIComponent(n)}?uploadType=media`,{method:"PATCH",headers:_e(e,{"Content-Type":"application/json; charset=UTF-8"}),body:a});await ge(r,"更新 Google 備份失敗")}async function us({accessToken:e,reauth:t,filename:n,jsonText:a}){let r=e;const i=typeof t=="function"?async()=>{const d=await t();return r=String(d??"").trim()||r,r}:null,o=await ds(r,i,n),s=o[0]||null;if(s?.id){await Es(r,i,s.id,a);for(const d of o.slice(1))d?.id&&await cs(r,i,d.id);return{fileId:s.id,filename:n,modifiedTime:new Date().toISOString(),created:!1}}const c=await _s(r,i,n,a);return{fileId:String(c?.id??""),filename:String(c?.name??n),modifiedTime:String(c?.modifiedTime??new Date().toISOString()),created:!0}}async function Sr({accessToken:e,reauth:t,pageSize:n=100}={}){const a=[];let r="";const i=Math.min(1e3,Math.max(1,Number(n)||100)),o=encodeURIComponent("nextPageToken,files(id,name,modifiedTime,size)");do{let s=`${be}?spaces=appDataFolder&fields=${o}&orderBy=modifiedTime desc&pageSize=${i}`;r&&(s+=`&pageToken=${encodeURIComponent(r)}`);const c=await me(e,t,s,{method:"GET",headers:_e(e)});await ge(c,"讀取 Google 備份清單失敗");const d=await c.json(),E=Array.isArray(d?.files)?d.files:[];a.push(...E),r=String(d?.nextPageToken??"").trim()}while(r);return a}async function ls({accessToken:e,reauth:t,fileId:n,pageSize:a=200}={}){const r=String(n??"").trim();if(!r)throw new Error("缺少 Google Drive 檔案 id");const i=[];let o="";const s=Math.min(1e3,Math.max(1,Number(a)||200)),c=encodeURIComponent("nextPageToken,revisions(id,modifiedTime,size,keepForever)");do{let d=`${be}/${encodeURIComponent(r)}/revisions?fields=${c}&pageSize=${s}`;o&&(d+=`&pageToken=${encodeURIComponent(o)}`);const E=await me(e,t,d,{method:"GET",headers:_e(e)});await ge(E,"讀取 Google Drive 檔案版本失敗");const u=await E.json(),T=Array.isArray(u?.revisions)?u.revisions:[];i.push(...T),o=String(u?.nextPageToken??"").trim()}while(o);return i.map(d=>({id:String(d?.id??"").trim(),modifiedTime:String(d?.modifiedTime??"").trim(),size:d?.size!=null?String(d.size):"",keepForever:!!d?.keepForever})).filter(d=>d.id).sort((d,E)=>String(E.modifiedTime).localeCompare(String(d.modifiedTime)))}async function Rr({accessToken:e,reauth:t,fileId:n,revisionId:a}={}){const r=String(n??"").trim();if(!r)throw new Error("缺少 Google Drive 檔案 id");const i=String(a??"").trim(),o=i?`${be}/${encodeURIComponent(r)}/revisions/${encodeURIComponent(i)}?alt=media`:`${be}/${encodeURIComponent(r)}?alt=media`,s=await me(e,t,o,{method:"GET",headers:_e(e)});return await ge(s,"下載 Google 備份失敗"),s.text()}function br(e){const t=e?.deleted_at;return t==null?!1:String(t).trim()!==""}function Ts(e){const t=String(e??"").trim();if(!t)return"";const n=t.match(/^(\d{4})-(\d{2})/);if(n)return`${n[1]}-${n[2]}`;const a=Date.parse(t);if(!Number.isFinite(a))return"";const r=new Date(a);if(Number.isNaN(r.getTime()))return"";const i=r.getUTCFullYear(),o=String(r.getUTCMonth()+1).padStart(2,"0");return`${i}-${o}`}function ms(e){return!e||typeof e!="object"?[]:Array.isArray(e.ledgers)&&e.backup_scope==="all_ledgers"?e.ledgers.filter(t=>t&&typeof t=="object"):e.tables&&typeof e.tables=="object"?[e]:[]}function gs(e){const t=Array.isArray(e?.tables?.ledgers)?e.tables.ledgers:[],n=t.find(i=>i&&!br(i))||t[0],a=String(n?.name??e?.ledger_name??"").trim();return a||String(e?.ledger_id??n?.id??"").trim()||""}function Ls(e){const t=Array.isArray(e?.tables?.transactions)?e.tables.transactions:[];let n=0;const a=Object.create(null);for(const r of t){if(!r||typeof r!="object"||br(r))continue;n+=1;const i=Ts(r.occurred_at);i&&(a[i]=(a[i]||0)+1)}return{count:n,monthDistribution:a}}function Ns(...e){const t=Object.create(null);for(const n of e)if(!(!n||typeof n!="object"))for(const[a,r]of Object.entries(n))t[a]=(t[a]||0)+Number(r||0);return t}function Xe(e){const t={ok:!1,parseError:"",backupScope:"",exportedAt:"",ledgerNames:[],ledgerCount:0,transactionCount:0,monthDistribution:{},months:[],earliestMonth:"",latestMonth:""};if(!e||typeof e!="object")return{...t,parseError:"invalid_payload"};const n=ms(e);if(!n.length)return{...t,parseError:"missing_ledgers",backupScope:String(e.backup_scope??"").trim(),exportedAt:String(e.exported_at??"").trim()};const a=[];let r=0,i=Object.create(null);for(const s of n){const c=gs(s);c&&a.push(c);const d=Ls(s);r+=d.count,i=Ns(i,d.monthDistribution)}const o=Object.keys(i).sort();return{ok:!0,parseError:"",backupScope:String(e.backup_scope??(n.length>1?"all_ledgers":"single")).trim(),exportedAt:String(e.exported_at??"").trim(),ledgerNames:a,ledgerCount:n.length,transactionCount:r,monthDistribution:i,months:o,earliestMonth:o[0]||"",latestMonth:o[o.length-1]||""}}function Dr(e){const t=String(e??"");if(!t.trim())return Xe(null);try{return Xe(JSON.parse(t))}catch{return{...Xe(null),parseError:"json_parse_error"}}}function ps(e,t,n={}){const a=e&&typeof e=="object"?e:{},r=t&&typeof t=="object"?t:{},i=String(n.remoteModifiedAt??a.exportedAt??"").trim(),o=String(n.localModifiedAt??r.exportedAt??"").trim();let s="unknown";const c=Date.parse(i),d=Date.parse(o);Number.isFinite(c)&&Number.isFinite(d)&&(c<d-1e3?s="older":c>d+1e3?s="newer":s="same");const E=Array.isArray(a.months)?a.months:[],u=Array.isArray(r.months)?r.months:[],T=new Set(E),m=new Set(u),L=u.filter(S=>!T.has(S)),v=E.filter(S=>!m.has(S));let f="unknown";!a.ok&&!r.ok?f="unknown":!E.length&&!u.length||!L.length&&!v.length?f="equal":!L.length&&v.length?f="remote_wider":L.length&&!v.length?f="remote_narrower":E.length&&u.length?f="overlapping":f="disjoint";const M=Number(r.transactionCount??0)||0,V=Number(a.transactionCount??0)||0,re=!!(a.ok&&r.ok&&(L.length>0||M>0&&V<M));return{ageRelation:s,coverage:f,monthsOnlyInLocal:L,monthsOnlyInRemote:v,localTxCount:M,remoteTxCount:V,warnIncompleteRemote:re,warnOlderRemote:s==="older",warnNewerRemote:s==="newer"}}function qd(e,{limit:t=8}={}){const n=Object.entries(e||{}).sort(([i],[o])=>i.localeCompare(o));if(!n.length)return"";const a=n.slice(0,Math.max(1,t)).map(([i,o])=>`${i}:${o}`),r=n.length-a.length;return r>0?`${a.join(", ")} (+${r})`:a.join(", ")}const fs=["ledgers","account_groups","accounts","category_groups","categories","transactions","transaction_attachments","counterparties","loans","loan_payments","reimbursement_advances","reimbursement_advance_usages","reimbursements","reimbursement_items","budget_save_settlements","budgets","budget_containers","budget_items","savings_jars","securities","security_transactions","credit_statements","credit_repayments","credit_repayment_allocations","transaction_postings","bank_connections","bank_accounts","bank_transactions","bank_sync_rules","app_settings","deleted_log"],As=Object.freeze({app_settings:"key",bank_sync_rules:"connection_id",savings_jars:"account_id"});function w(e){return JSON.parse(JSON.stringify(e??null))}function l(e){return String(e??"").trim()}function ce(e){if(e==null||e==="")return Number.NaN;if(e instanceof Date){const a=e.getTime();return Number.isFinite(a)?a:Number.NaN}if(typeof e=="number")return Number.isFinite(e)?Math.abs(e)<1e11?Math.round(e*1e3):Math.round(e):Number.NaN;const t=l(e);if(!t)return Number.NaN;if(/^-?\d+(\.\d+)?$/.test(t))return ce(Number(t));const n=Date.parse(t);return Number.isFinite(n)?n:Number.NaN}function ot(e){const t=ce(e);return Number.isFinite(t)?new Date(t).toISOString():""}function g(e,t){const n=e?.tables?.[t];return Array.isArray(n)?n.map(a=>w(a)):[]}function Vt(e,t){const n=fs.filter(r=>r!=="deleted_log"),a=new Set;for(const r of[e,t]){const i=r?.tables&&typeof r.tables=="object"?Object.keys(r.tables):[];for(const o of i){const s=l(o);!s||s==="deleted_log"||n.includes(s)||a.add(s)}}return[...n,...Array.from(a).sort((r,i)=>r.localeCompare(i))]}function O(e,t,n=0){const a=As[e];if(a){const i=l(t?.[a]);if(i)return i}const r=l(t?.id);return r||`__row_${e}_${n}_${JSON.stringify(t??{})}`}function P(e){const t=[e?.deleted_at,e?.updated_at,e?.occurred_at,e?.posted_at,e?.paid_at,e?.received_at,e?.submitted_at,e?.approved_at,e?.settled_at,e?.last_seen_at,e?.first_seen_at,e?.last_sync_at,e?.created_at];for(const n of t){const a=ce(n);if(Number.isFinite(a))return a}return 0}function We(e,t){return[...t].sort((n,a)=>{const r=O(e,n),i=O(e,a),o=r.localeCompare(i);if(o!==0)return o;const s=P(n)-P(a);return s!==0?s:JSON.stringify(n).localeCompare(JSON.stringify(a))})}function Jt(e){return[...e].sort((t,n)=>{const a=l(t?.table_name),r=l(n?.table_name),i=a.localeCompare(r);if(i!==0)return i;const o=l(t?.row_pk),s=l(n?.row_pk),c=o.localeCompare(s);if(c!==0)return c;const d=P(t)-P(n);return d!==0?d:JSON.stringify(t).localeCompare(JSON.stringify(n))})}function p(e=[],t="id"){return new Set(e.map(n=>l(n?.[t])).filter(Boolean))}function pe(e,t=[],n=new Set){let a=e;for(const r of t){const i=l(a?.[r]);i&&!n.has(i)&&(a={...a,[r]:null})}return a}const D=Object.freeze({created_at:"1970-01-01T00:00:00.000Z",updated_at:"1970-01-01T00:00:00.000Z"});function y(e,t,n,a){const r=p(e[t]),i=[];for(const o of n){const s=l(o);!s||r.has(s)||(i.push(a(s)),r.add(s))}return i.length===0?0:(e[t]=We(t,[...g({tables:e},t),...i]),i.length)}function R(e,t){const n=new Set;for(const a of e){const r=l(a?.[t]);r&&n.add(r)}return n}function Os(e,t,n="system_fk_preserve_accounts"){return t.synthesizedAccountGroups+=y(e,"account_groups",[n],a=>({id:a,name:"資料保全群組",type:"other",sort_order:9999,is_archived:1,...D})),n}function ie(e,t,n){if(!n?.length)return 0;const a=Os(e,t);return y(e,"accounts",n,r=>({id:r,group_id:a,name:"資料保全帳戶",account_type:"asset",account_kind:"cash",allow_negative:1,opening_balance_minor:0,currency_code:"TWD",include_in_assets:0,include_in_group_statistics:0,sort_order:9999,is_archived:1,...D}))}function Dt(e,t,n){if(!n?.length)return 0;const a="system_fk_preserve_categories";return t.synthesizedCategoryGroups+=y(e,"category_groups",[a],r=>({id:r,name:"資料保全分類群組",type:"expense",sort_order:9999,is_archived:1,...D})),y(e,"categories",n,r=>({id:r,group_id:a,name:"資料保全分類",type:"expense",sort_order:9999,is_archived:1,...D}))}function Ss(e){const t={...e},n={synthesizedAccountGroups:0,synthesizedAccounts:0,synthesizedCategoryGroups:0,synthesizedCategories:0,synthesizedCounterparties:0,synthesizedBudgets:0,synthesizedBankConnections:0,synthesizedLoans:0,nulledOptionalRefs:0,droppedChildRows:0},a=g({tables:t},"accounts");n.synthesizedAccountGroups+=y(t,"account_groups",R(a,"group_id"),_=>({id:_,name:"資料保全群組",type:"other",sort_order:9999,is_archived:1,...D})),t.accounts=a;let r=p(t.accounts);const i=g({tables:t},"categories");n.synthesizedCategoryGroups+=y(t,"category_groups",R(i,"group_id"),_=>({id:_,name:"資料保全分類群組",type:"expense",sort_order:9999,is_archived:1,...D})),t.categories=i;let o=p(t.categories);const s=g({tables:t},"transactions"),c=[...R(s,"account_id")].filter(_=>!r.has(_));n.synthesizedAccounts+=ie(t,n,c),r=p(t.accounts);const d=[...R(s,"peer_account_id")].filter(_=>!r.has(_));n.synthesizedAccounts+=ie(t,n,d),r=p(t.accounts);const E=[...R(s,"category_id")].filter(_=>!o.has(_));n.synthesizedCategories+=Dt(t,n,E),o=p(t.categories),t.transactions=s;const u=p(t.transactions);t.transaction_attachments=g({tables:t},"transaction_attachments");const T=g({tables:t},"loans");n.synthesizedCounterparties+=y(t,"counterparties",R(T,"counterparty_id"),_=>({id:_,name:"資料保全往來對象",...D})),t.loans=T;let m=p(t.loans);const L=g({tables:t},"loan_payments"),v=[...R(L,"loan_id")].filter(_=>!m.has(_));n.synthesizedLoans+=y(t,"loans",v,_=>({id:_,counterparty_id:null,principal_minor:0,status:"active",...D})),m=p(t.loans),n.synthesizedAccounts+=ie(t,n,[...R(L,"account_id")].filter(_=>!r.has(_))),r=p(t.accounts),t.loan_payments=L.map(_=>pe(_,["generated_tx_id","generated_interest_tx_id"],u));const f=g({tables:t},"reimbursement_advances");n.synthesizedAccounts+=ie(t,n,[...R(f,"account_id")].filter(_=>!r.has(_))),r=p(t.accounts),t.reimbursement_advances=f.map(_=>pe(_,["source_tx_id"],u));const M=p(t.reimbursement_advances),V=g({tables:t},"reimbursement_advance_usages"),re=[...R(V,"advance_id")].filter(_=>!M.has(_));if(re.length>0){const _="system_fk_preserve_advance_account";n.synthesizedAccounts+=ie(t,n,[_]),r=p(t.accounts),y(t,"reimbursement_advances",re,x=>({id:x,account_id:_,amount_minor:0,...D}))}t.reimbursement_advance_usages=V.map(_=>{const x=l(_?.expense_tx_id),K=pe(_,["expense_tx_id"],u);return x&&!l(K?.expense_tx_id)&&(n.nulledOptionalRefs+=1),K});const Ue=g({tables:t},"reimbursements");n.synthesizedCounterparties+=y(t,"counterparties",R(Ue,"counterparty_id"),_=>({id:_,name:"資料保全往來對象",...D})),t.reimbursements=Ue.map(_=>{const x=l(_?.paid_tx_id),K=pe(_,["paid_tx_id"],u);return x&&!l(K?.paid_tx_id)&&(n.nulledOptionalRefs+=1),K});const he=p(t.reimbursements),S=g({tables:t},"reimbursement_items"),U=[...R(S,"reimbursement_id")].filter(_=>!he.has(_));y(t,"reimbursements",U,_=>({id:_,title:"資料保全請款",status:"open",total_minor:0,...D})),n.synthesizedAccounts+=ie(t,n,[...R(S,"account_id")].filter(_=>!r.has(_))),r=p(t.accounts),n.synthesizedCategories+=Dt(t,n,[...R(S,"category_id")].filter(_=>!o.has(_))),o=p(t.categories),t.reimbursement_items=S.map(_=>{const x=l(_?.transaction_id),K=pe(_,["transaction_id"],u);return x&&!l(K?.transaction_id)&&(n.nulledOptionalRefs+=1),K});const B=g({tables:t},"budgets");t.budgets=B;let k=p(t.budgets);const H=g({tables:t},"budget_containers"),ae=[...R(H,"budget_id")].filter(_=>!k.has(_));n.synthesizedBudgets+=y(t,"budgets",ae,_=>({id:_,month_key:"1970-01",...D})),k=p(t.budgets),t.budget_containers=H;const J=g({tables:t},"budget_items"),Le=[...R(J,"budget_id")].filter(_=>!k.has(_));n.synthesizedBudgets+=y(t,"budgets",Le,_=>({id:_,month_key:"1970-01",...D})),k=p(t.budgets),n.synthesizedCategories+=Dt(t,n,J.filter(_=>l(_?.scope_type)==="category").map(_=>l(_?.category_id)).filter(_=>_&&!o.has(_))),o=p(t.categories),n.synthesizedCategoryGroups+=y(t,"category_groups",J.filter(_=>l(_?.scope_type)==="group").map(_=>l(_?.category_group_id)).filter(_=>_&&!p(t.category_groups).has(_)),_=>({id:_,name:"資料保全分類群組",type:"expense",sort_order:9999,is_archived:1,...D})),t.budget_items=J;const ze=g({tables:t},"savings_jars");n.synthesizedAccounts+=ie(t,n,[...R(ze,"account_id")].filter(_=>!r.has(_))),r=p(t.accounts),t.savings_jars=ze;const Gr=g({tables:t},"bank_connections");t.bank_connections=Gr;let Z=p(t.bank_connections);const Nt=g({tables:t},"bank_accounts"),Pr=[...R(Nt,"connection_id")].filter(_=>!Z.has(_));n.synthesizedBankConnections+=y(t,"bank_connections",Pr,_=>({id:_,provider:"fk_preserve",display_name:"資料保全銀行連線",...D})),Z=p(t.bank_connections),n.synthesizedAccounts+=ie(t,n,[...R(Nt,"mapped_account_id")].filter(_=>!r.has(_))),r=p(t.accounts),t.bank_accounts=Nt;let tn=p(t.bank_accounts);const pt=g({tables:t},"bank_transactions"),jr=[...R(pt,"connection_id")].filter(_=>!Z.has(_));n.synthesizedBankConnections+=y(t,"bank_connections",jr,_=>({id:_,provider:"fk_preserve",display_name:"資料保全銀行連線",...D})),Z=p(t.bank_connections);const nn=[...R(pt,"bank_account_id")].filter(_=>!tn.has(_));if(nn.length>0){const _=[...Z][0]||"system_fk_preserve_bank_connection";[...Z].length||(n.synthesizedBankConnections+=y(t,"bank_connections",[_],x=>({id:x,provider:"fk_preserve",display_name:"資料保全銀行連線",...D})),Z=p(t.bank_connections)),y(t,"bank_accounts",nn,x=>({id:x,connection_id:[...Z][0],display_name:"資料保全銀行帳戶",...D})),tn=p(t.bank_accounts)}t.bank_transactions=pt.map(_=>{const x=l(_?.imported_txn_id),K=pe(_,["imported_txn_id"],u);return x&&!l(K?.imported_txn_id)&&(n.nulledOptionalRefs+=1),K});const rn=g({tables:t},"bank_sync_rules"),Hr=[...R(rn,"connection_id")].filter(_=>!Z.has(_));return n.synthesizedBankConnections+=y(t,"bank_connections",Hr,_=>({id:_,provider:"fk_preserve",display_name:"資料保全銀行連線",...D})),t.bank_sync_rules=rn,n.droppedChildRows=0,t.__fk_preserve_report=n,t}function Rs(e){try{const t=JSON.parse(String(e?.payload_json??"{}"));return t&&typeof t=="object"?t:null}catch{return null}}function bs(e=[]){let t=0;for(const n of e)t=Math.max(t,P(n));return t}function Ds(e,t){const n={...e},a=(r,i,o)=>{const s=l(i);if(!s||p(n[r]).has(s))return;const d=`${r}::${s}`,E=t.get(d);if(!E)return;const u=ce(E.deleted_at),T=bs(o);if(!Number.isFinite(u)||!(T>u))return;const m=Rs(E);if(!m)return;const L={...w(m),id:s,updated_at:ot(m.updated_at)||ot(T)||new Date().toISOString()};n[r]=We(r,[...g({tables:n},r),L]),t.delete(d)};for(const r of g({tables:n},"transactions"))a("accounts",r?.account_id,[r]),a("accounts",r?.peer_account_id,[r]),a("categories",r?.category_id,[r]);for(const r of g({tables:n},"accounts"))a("account_groups",r?.group_id,[r,...g({tables:n},"transactions").filter(i=>l(i?.account_id)===l(r?.id)||l(i?.peer_account_id)===l(r?.id))]);for(const r of g({tables:n},"categories"))a("category_groups",r?.group_id,[r,...g({tables:n},"transactions").filter(i=>l(i?.category_id)===l(r?.id))]);return n}function ys(e){if(!e||typeof e!="object")return null;const t=l(e.table_name),n=l(e.row_pk);if(!t||!n)return null;const a=ot(e.deleted_at||e.updated_at||e.created_at)||new Date().toISOString();return{...w(e),table_name:t,row_pk:n,payload_json:String(e?.payload_json??"{}"),deleted_at:a}}function Zt(e=[]){const t=new Map;for(const n of e){const a=ys(n);if(!a)continue;const r=`${a.table_name}::${a.row_pk}`,i=ce(a.deleted_at),o=t.get(r),s=ce(o?.deleted_at);(!o||i>=s)&&t.set(r,a)}return t}function fe(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Is(e,t,n="remote"){return yr(e,t,n).row}function De(e,t){return`${e}::${t}`}function yr(e,t,n="remote"){if(!e&&!t)return{row:null,source:"none"};if(!e)return{row:w(t),source:"remote"};if(!t)return{row:w(e),source:"local"};if(fe(e,t))return{row:w(e),source:"same"};const a=P(e),r=P(t);if(a>r)return{row:w(e),source:"local"};if(r>a)return{row:w(t),source:"remote"};const i=n==="local"?"local":"remote";return{row:w(i==="local"?e:t),source:i}}function Ft(e,t,n){for(const[a,r]of g({tables:e},t).entries())if(O(t,r,a)===n)return r;return null}function G(e,t,n,a,r){const i=l(n);if(!i||!a||!r)return;const o=`${t}::${i}`;e.has(o)||e.set(o,{type:t,unitKey:i,members:[]});const s=e.get(o);s.members.some(c=>c.tableName===a&&c.rowKey===r)||s.members.push({tableName:a,rowKey:r})}function Cs(e,t){const n=new Map;for(const a of[e,t])for(const r of g({tables:a},"transactions")){const i=l(r?.transfer_group_id);if(!i)continue;const o=O("transactions",r);G(n,"transfer_group",i,"transactions",o)}for(const a of[e,t])for(const r of g({tables:a},"loan_payments")){const i=l(r?.id)||O("loan_payments",r);G(n,"loan_payment_bundle",i,"loan_payments",O("loan_payments",r));for(const o of[r?.generated_tx_id,r?.generated_interest_tx_id]){const s=l(o);if(!s)continue;const c=g({tables:a},"transactions").find(d=>l(d?.id)===s);c&&G(n,"loan_payment_bundle",i,"transactions",O("transactions",c))}}for(const a of[e,t])for(const r of g({tables:a},"reimbursements")){const i=l(r?.id);if(i){G(n,"reimbursement_bundle",i,"reimbursements",O("reimbursements",r));for(const o of g({tables:a},"reimbursement_items"))l(o?.reimbursement_id)===i&&G(n,"reimbursement_bundle",i,"reimbursement_items",O("reimbursement_items",o))}}for(const a of[e,t])for(const r of g({tables:a},"reimbursement_advances")){const i=l(r?.id);if(i){G(n,"advance_bundle",i,"reimbursement_advances",O("reimbursement_advances",r));for(const o of g({tables:a},"reimbursement_advance_usages"))l(o?.advance_id)===i&&G(n,"advance_bundle",i,"reimbursement_advance_usages",O("reimbursement_advance_usages",o))}}for(const a of[e,t])for(const r of g({tables:a},"credit_statements")){const i=l(r?.account_id);if(!i)continue;const o=i;G(n,"credit_card_bundle",o,"credit_statements",O("credit_statements",r));const s=g({tables:a},"accounts").find(d=>l(d?.id)===i);s&&G(n,"credit_card_bundle",o,"accounts",O("accounts",s));for(const d of g({tables:a},"credit_repayments")){if(l(d?.account_id)!==i)continue;G(n,"credit_card_bundle",o,"credit_repayments",O("credit_repayments",d));const E=l(d?.id);for(const u of g({tables:a},"credit_repayment_allocations"))l(u?.repayment_id)===E&&G(n,"credit_card_bundle",o,"credit_repayment_allocations",O("credit_repayment_allocations",u))}const c=l(r?.id);for(const d of g({tables:a},"transaction_postings")){if(l(d?.statement_id)!==c)continue;G(n,"credit_card_bundle",o,"transaction_postings",O("transaction_postings",d));const E=l(d?.transaction_id);if(!E)continue;const u=g({tables:a},"transactions").find(T=>l(T?.id)===E);u&&G(n,"credit_card_bundle",o,"transactions",O("transactions",u))}}return Array.from(n.values())}function Us(e,t,n,a){let r=0,i=0;for(const o of e.members){const s=Ft(t,o.tableName,o.rowKey),c=Ft(n,o.tableName,o.rowKey);s&&(r=Math.max(r,P(s))),c&&(i=Math.max(i,P(c)))}return r>i?"local":i>r?"remote":a==="local"?"local":"remote"}function hs(e,t,n,a){const r=(e[t]??[]).filter((i,o)=>O(t,i,o)!==n);a&&r.push(w(a)),e[t]=We(t,r)}function Ir({mergedTables:e,rowDecisions:t,localTables:n,remoteTables:a,prefer:r}){const i=[],o={...e};for(const s of Cs(n,a)){const c=new Set;for(const u of s.members){const T=t.get(De(u.tableName,u.rowKey));(T?.source==="local"||T?.source==="remote")&&c.add(T.source)}if(c.size<2)continue;const d=Us(s,n,a,r);i.push({tableName:s.members[0]?.tableName??"",rowKey:s.unitKey,conflictType:s.type,unitKey:s.unitKey,resolution:d});const E=d==="local"?n:a;for(const u of s.members){const T=Ft(E,u.tableName,u.rowKey);hs(o,u.tableName,u.rowKey,T),t.set(De(u.tableName,u.rowKey),{source:T?d:"none",row:T?w(T):null})}}return{conflicts:i,mergedTables:o}}function Cr(e,t,n){const a=[];for(const[r,i]of t.entries()){const o=`${e}::${r}`,s=n.get(o),c=P(i),d=ce(s?.deleted_at);s&&Number.isFinite(d)&&d>=c||(s&&c>d&&n.delete(o),a.push(i))}return We(e,a)}function ws(e,t,n={}){const a=n?.prefer==="local"?"local":"remote",r=Vt(e,t),i=Zt([...g(e,"deleted_log"),...g(t,"deleted_log")]),o={},s=new Map;for(const d of r){const E=new Map;for(const[u,T]of g(e,d).entries()){const m=O(d,T,u),L=w(T);E.set(m,L),s.set(De(d,m),{source:"local",row:L})}for(const[u,T]of g(t,d).entries()){const m=O(d,T,u),L=yr(E.get(m),T,a);L.row?E.set(m,L.row):E.delete(m),s.set(De(d,m),L)}o[d]=Cr(d,E,i)}o.deleted_log=Jt(Array.from(i.values()));const c=Ir({mergedTables:o,rowDecisions:s,localTables:e.tables,remoteTables:t.tables,prefer:a});return{mergedTables:c.mergedTables,conflicts:c.conflicts}}function q(e){const t=w(e);if(!t||typeof t!="object")return{schema_version:null,ledger_id:"",exported_at:"",tables:{}};const n=Vt(t,null),a=Zt(g(t,"deleted_log")),r={};for(const d of n){const E=new Map;for(const[T,m]of g(t,d).entries()){const L=O(d,m,T),v=E.get(L);E.set(L,Is(v,m,"remote"))}const u=[];for(const[T,m]of E.entries()){const L=`${d}::${T}`,v=a.get(L),f=P(m),M=ce(v?.deleted_at);v&&Number.isFinite(M)&&M>=f||(v&&f>M&&a.delete(L),u.push(m))}r[d]=We(d,u)}const i=Ds(r,a),o=Ss(i),s=o.__fk_preserve_report||null;delete o.__fk_preserve_report,o.deleted_log=Jt(Array.from(a.values()));const c={schema_version:t.schema_version??null,ledger_id:l(t.ledger_id),exported_at:ot(t.exported_at),tables:o};return s&&(c.fk_preserve_report=s),c}function ks(e){return q(e)}function zd(e,t,n={}){const a=q(e),r=q(t),i=l(a.ledger_id||r.ledger_id);if(a.ledger_id&&r.ledger_id&&a.ledger_id!==r.ledger_id)throw new Error("共同帳本快照 ledger_id 不一致，無法合併");const{mergedTables:o,conflicts:s}=ws(a,r,n),c=q({schema_version:r.schema_version??a.schema_version??null,ledger_id:i,exported_at:new Date().toISOString(),tables:o});return n?.detectConflicts?{mergedSnapshot:c,conflicts:s,hasConflicts:s.length>0}:c}function Vd(e,t,n,a={}){const r=q(e),i=q(t),o=q(n),s=l(i.ledger_id||o.ledger_id||r.ledger_id);if(i.ledger_id&&o.ledger_id&&i.ledger_id!==o.ledger_id)throw new Error("共同帳本快照 ledger_id 不一致，無法合併");const c=a?.prefer==="local"?"local":"remote",d=Vt(i,o),E=Zt([...g(r,"deleted_log"),...g(i,"deleted_log"),...g(o,"deleted_log")]),u={},T=[],m=new Map;for(const f of d){const M=new Map;for(const[S,U]of g(r,f).entries())M.set(O(f,U,S),w(U));const V=new Map;for(const[S,U]of g(i,f).entries())V.set(O(f,U,S),w(U));const re=new Map;for(const[S,U]of g(o,f).entries())re.set(O(f,U,S),w(U));const Ue=new Set([...M.keys(),...V.keys(),...re.keys()]),he=new Map;for(const S of Ue){const U=M.get(S)??null,B=V.get(S)??null,k=re.get(S)??null;let H=null,ae="same";if(fe(B,U))H=k,ae=k&&!fe(k,U)?"remote":"same";else if(fe(k,U))H=B,ae=B&&!fe(B,U)?"local":"same";else if(fe(B,k))H=B,ae="same";else{const J=P(B),Le=P(k);if(J!==Le){const ze=Le>J;H=c==="local"?J>=Le?B:k:Le>=J?k:B,ae=ze?"remote":"local"}else H=c==="local"?B:k,ae=c;T.push({tableName:f,rowKey:S,baseRow:U,localRow:B,remoteRow:k,chosenRow:H,resolution:c})}if(!H){m.set(De(f,S),{source:"none",row:null});continue}he.set(S,H),m.set(De(f,S),{source:ae,row:H})}u[f]=Cr(f,he,E)}u.deleted_log=Jt(Array.from(E.values()));const L=Ir({mergedTables:u,rowDecisions:m,localTables:i.tables,remoteTables:o.tables,prefer:c});return T.push(...L.conflicts),{mergedSnapshot:q({schema_version:o.schema_version??i.schema_version??r.schema_version??null,ledger_id:s,exported_at:new Date().toISOString(),tables:L.mergedTables}),conflicts:T,hasConflicts:T.length>0}}function Jd(e=[],t={}){const n=t?.prefer==="local"?"local":"remote",a=l(t?.mergeMode)||"unknown",r=Array.isArray(e)?e:[];return{mergeMode:a,prefer:n,conflictCount:r.length,conflicts:r.map(i=>({tableName:l(i?.tableName),rowKey:l(i?.rowKey),conflictType:l(i?.conflictType)||"row",unitKey:l(i?.unitKey),resolution:l(i?.resolution)||n})),recordedAt:new Date().toISOString()}}function Zd(e,t){const n=q(e),a=q(t),r={schema_version:n.schema_version??null,ledger_id:n.ledger_id,tables:n.tables},i={schema_version:a.schema_version??null,ledger_id:a.ledger_id,tables:a.tables};return JSON.stringify(r)===JSON.stringify(i)}const vs=Object.freeze(["account_groups","accounts","category_groups","categories","transactions","wear_applied","transaction_attachments","counterparties","loans","loan_payments","reimbursement_advances","reimbursement_advance_usages","reimbursements","reimbursement_items","budget_save_settlements","budgets","budget_containers","budget_items","savings_jars","securities","security_transactions","credit_statements","credit_repayments","credit_repayment_allocations","transaction_postings","bank_connections","bank_accounts","bank_transactions","bank_sync_rules","app_settings","deleted_log"]);function N(...e){return Object.freeze(new Set(e))}function I(e){const t={};for(const[n,a]of Object.entries(e))t[n]=Object.freeze([...a]);return Object.freeze(t)}const Xs=Object.freeze({account_groups:{columns:N("ledger_id","id","name","type","sort_order","is_archived","created_at","updated_at","deleted_at"),required:Object.freeze(["id","name","type","created_at","updated_at"]),enums:I({type:["cash","bank","ewallet","credit_card","other"]})},accounts:{columns:N("ledger_id","id","group_id","name","account_type","account_kind","allow_negative","opening_balance_minor","currency_code","icon","credit_limit_minor","repayment_reminder_day","statement_close_day","payment_due_day","card_last4","issuer","sort_order","is_archived","created_at","updated_at","deleted_at","include_in_assets","include_in_group_statistics","is_settlement"),required:Object.freeze(["id","group_id","name","created_at","updated_at"]),enums:I({account_type:["asset","liability"],account_kind:["cash","credit"]})},category_groups:{columns:N("ledger_id","id","name","kind","sort_order","is_archived","created_at","updated_at","deleted_at"),required:Object.freeze(["id","name","kind","created_at","updated_at"]),enums:I({kind:["expense","income","both"]})},categories:{columns:N("ledger_id","id","group_id","name","kind","icon","is_budgetable","sort_order","is_archived","created_at","updated_at","deleted_at","default_include_in_analysis","default_include_in_budget","default_is_reimbursable","system_key"),required:Object.freeze(["id","group_id","name","kind","created_at","updated_at"]),enums:I({kind:["expense","income","both"]})},transactions:{columns:N("ledger_id","id","type","transfer_group_id","account_id","peer_account_id","category_id","amount_minor","occurred_at","posted_at","note","location","tags_json","origin_type","external_ref_id","idempotency_key","include_in_budget","include_in_analysis","created_at","updated_at","deleted_at","is_reimbursable","reimbursement_state","reimbursed_at","reimburse_target_minor","created_by_user_id","created_by_display_name","updated_by_user_id","updated_by_display_name"),required:Object.freeze(["id","type","account_id","amount_minor","occurred_at","created_at","updated_at"]),enums:I({type:["expense","income","adjustment","transfer"],origin_type:["manual","loan_payment","reimbursement","import","recurring","refund","wear"],reimbursement_state:["none","pending","reimbursed"]})},wear_applied:{columns:N("idempotency_key","ledger_id","tx_id","applied_at"),required:Object.freeze(["idempotency_key","ledger_id","tx_id","applied_at"])},transaction_attachments:{columns:N("ledger_id","id","transaction_id","file_uri","mime_type","file_size","checksum","created_at"),required:Object.freeze(["id","transaction_id","file_uri","mime_type","file_size","created_at"])},counterparties:{columns:N("ledger_id","id","name","contact_json","note","is_archived","created_at","updated_at"),required:Object.freeze(["id","name","created_at","updated_at"])},loans:{columns:N("ledger_id","id","counterparty_id","direction","principal_minor","interest_rule_json","start_date","due_date","status","settled_at","note","created_at","updated_at","deleted_at"),required:Object.freeze(["id","counterparty_id","direction","principal_minor","start_date","status","created_at","updated_at"]),enums:I({direction:["lend","borrow"],status:["active","partial","settled","void"]})},loan_payments:{columns:N("ledger_id","id","loan_id","account_id","paid_at","amount_minor","principal_component_minor","interest_component_minor","generated_tx_id","generated_interest_tx_id","note","created_at","updated_at"),required:Object.freeze(["id","loan_id","account_id","paid_at","amount_minor","created_at","updated_at"])},reimbursement_advances:{columns:N("ledger_id","id","account_id","source_tx_id","amount_minor","used_minor","note","received_at","created_at","updated_at","deleted_at","category_id","return_amount_minor"),required:Object.freeze(["id","account_id","received_at","created_at","updated_at"])},reimbursement_advance_usages:{columns:N("ledger_id","id","advance_id","expense_tx_id","amount_minor","created_at","updated_at"),required:Object.freeze(["id","advance_id","expense_tx_id","created_at","updated_at"])},reimbursements:{columns:N("ledger_id","id","title","counterparty_id","status","submitted_at","approved_at","paid_at","paid_tx_id","total_minor","note","idempotency_key","created_at","updated_at","deleted_at"),required:Object.freeze(["id","title","status","created_at","updated_at"]),enums:I({status:["draft","submitted","in_review","approved","paid","rejected"]})},reimbursement_items:{columns:N("ledger_id","id","reimbursement_id","source_type","transaction_id","category_id","account_id","description","amount_minor","occurred_at","attachment_uri","created_at","updated_at","entry_type"),required:Object.freeze(["id","reimbursement_id","source_type","amount_minor","occurred_at","created_at","updated_at"]),enums:I({source_type:["transaction","manual","advance"],entry_type:["expense","income"]})},budget_save_settlements:{columns:N("ledger_id","id","scope_type","scope_ref_id","period_key","source_account_id","target_account_id","settled_amount_minor","status","transfer_group_id","last_error","created_at","updated_at"),required:Object.freeze(["id","scope_type","scope_ref_id","period_key","status","created_at","updated_at"]),enums:I({scope_type:["budget_item_day","budget_item_month","budget_total_month"],status:["settled","skipped_no_surplus","invalid_config","conflict","failed"]})},budgets:{columns:N("ledger_id","id","month_key","name","include_transfers","include_loan_repayments","include_reimbursed_expenses","created_at","updated_at","deleted_at","budget_save_total_enabled","budget_save_total_target_account_id","budget_save_total_source_account_id","period_key","period_start_date","period_end_date","period_mode"),required:Object.freeze(["id","month_key","created_at","updated_at"])},budget_containers:{columns:N("ledger_id","id","budget_id","name","amount_minor","budget_save_enabled","budget_save_target_account_id","budget_save_source_account_id","sort_order","created_at","updated_at","period_mode"),required:Object.freeze(["id","budget_id","name","created_at","updated_at"])},budget_items:{columns:N("ledger_id","id","budget_id","scope_type","category_id","category_group_id","amount_minor","sort_order","created_at","updated_at","amount_mode","day_rule_unit","day_rule_values_json","budget_save_enabled","budget_save_target_account_id","budget_save_source_account_id","budget_container_id"),required:Object.freeze(["id","budget_id","scope_type","amount_minor","created_at","updated_at"]),enums:I({scope_type:["category","group"],amount_mode:["fixed","daily_average"],day_rule_unit:["none","weekday","monthday"]})},savings_jars:{columns:N("ledger_id","account_id","goal_type","target_amount_minor","created_at","updated_at","auto_save_source_account_id","auto_save_amount_minor","auto_save_interval_value","auto_save_interval_unit","auto_save_start_date","auto_save_charge_day","auto_save_paused"),required:Object.freeze(["account_id","created_at","updated_at"]),enums:I({goal_type:["open","target"]})},securities:{columns:N("ledger_id","id","symbol","name","market","asset_class","currency_code","include_in_assets","manual_price_minor","manual_price_at","price_source","sort_order","is_archived","settlement_account_id","created_at","updated_at","deleted_at"),required:Object.freeze(["id","symbol","name","created_at","updated_at"]),enums:I({asset_class:["stock","etf"]})},security_transactions:{columns:N("ledger_id","id","security_id","type","occurred_at","quantity","price_minor","fee_minor","fee_mode","record_mode","principal_minor","proceeds_minor","settle_at","settlement_status","confirmed_at","cash_account_id","cash_principal_tx_id","cash_pnl_tx_id","source_buy_tx_id","note","created_at","updated_at","deleted_at"),required:Object.freeze(["id","security_id","type","occurred_at","quantity","price_minor","created_at","updated_at"]),enums:I({type:["buy","sell"],fee_mode:["into_cost","from_proceeds"],record_mode:["position","funds"],settlement_status:["scheduled","confirmed","cancelled"]})},credit_statements:{columns:N("ledger_id","id","account_id","period_start_inclusive","period_end_exclusive","status","closing_balance_minor","due_on","closed_at","closing_hash","close_token","created_at","updated_at","deleted_at"),required:Object.freeze(["id","account_id","period_start_inclusive","period_end_exclusive","status","created_at","updated_at"]),enums:I({status:["open","closed"]})},credit_repayments:{columns:N("ledger_id","id","account_id","source_account_id","amount_minor","paid_at","transfer_group_id","idempotency_key","note","created_at","updated_at","deleted_at"),required:Object.freeze(["id","account_id","source_account_id","amount_minor","paid_at","idempotency_key","created_at","updated_at"])},credit_repayment_allocations:{columns:N("ledger_id","id","repayment_id","statement_id","amount_minor","created_at","updated_at","deleted_at"),required:Object.freeze(["id","repayment_id","statement_id","amount_minor","created_at","updated_at"])},transaction_postings:{columns:N("ledger_id","id","transaction_id","role","account_id","category_id","amount_minor","statement_id","include_in_budget","include_in_analysis","created_at","updated_at","deleted_at"),required:Object.freeze(["id","transaction_id","role","amount_minor","created_at","updated_at"]),enums:I({role:["expense_accrual","card_liability","cash_transfer","fee","adjustment","reversal"]})},bank_connections:{columns:N("ledger_id","id","provider","provider_connection_id","status","user_label","last_sync_at","sync_cursor","last_sync_status","last_error","created_at","updated_at","deleted_at"),required:Object.freeze(["id","provider","provider_connection_id","created_at","updated_at"]),enums:I({status:["active","revoked","error"],last_sync_status:["idle","ok","error"]})},bank_accounts:{columns:N("ledger_id","id","connection_id","provider_account_id","account_mask","account_name","account_type","currency","enabled","user_label","mapped_account_id","created_at","updated_at","deleted_at"),required:Object.freeze(["id","connection_id","provider_account_id","account_name","created_at","updated_at"])},bank_transactions:{columns:N("ledger_id","id","connection_id","bank_account_id","provider_transaction_id","posted_at","amount_minor","currency","description","merchant","status","seen_in_app","imported","imported_txn_id","raw_json","first_seen_at","last_seen_at","created_at","updated_at","transaction_type","note","summary","balance_minor"),required:Object.freeze(["id","connection_id","bank_account_id","provider_transaction_id","posted_at","amount_minor","first_seen_at","last_seen_at","created_at","updated_at"]),enums:I({status:["pending","posted","reversed"]})},bank_sync_rules:{columns:N("ledger_id","connection_id","direction","exclude_keywords_json","min_amount_minor","include_pending","lookback_days","updated_at"),required:Object.freeze(["connection_id","updated_at"]),enums:I({direction:["all","income","expense"]})},app_settings:{columns:N("ledger_id","key","value_json","updated_at"),required:Object.freeze(["key","value_json","updated_at"])},deleted_log:{columns:N("id","ledger_id","table_name","row_pk","payload_json","deleted_at"),required:Object.freeze(["table_name","row_pk","payload_json","deleted_at"])}});function Ur(e,t){const n=String(e??"").trim();if(!/^[A-Za-z_][A-Za-z0-9_]*$/.test(n))throw new Error(`表 ${t} 欄位名稱不合法：${n}`);return n}function Fs(e,t){const n=Object.keys(t).map(o=>Ur(o,e));if(!n.length)throw new Error(`表 ${e} 缺少欄位資料`);const a=n.map(()=>"?").join(", "),r=`INSERT INTO ${e} (${n.join(", ")}) VALUES (${a});`,i=n.map(o=>t[o]);return{sql:r,values:i}}function hr(e){return e==null||e===""}function Ms(e,t,n){const a=t?.enums;if(!(!a||typeof a!="object"))for(const[r,i]of Object.entries(a)){if(!(r in n)||hr(n[r]))continue;const o=n[r];if(!i.includes(o))throw new Error(`表 ${e} 欄位 ${r} 值不符合約束：${o}`)}}function Bs(e){const t=e?.tables&&typeof e.tables=="object"?e.tables:{};for(const n of vs){const a=Array.isArray(t[n])?t[n]:[],r=Xs[n];if(!r)throw new Error(`表 ${n} 缺少匯入 schema 合約`);for(let i=0;i<a.length;i+=1){const o=a[i];if(!o||typeof o!="object"||Array.isArray(o))throw new Error(`表 ${n} 第 ${i+1} 筆資料格式無效`);const s={...o,ledger_id:o.ledger_id||"gate_ledger_probe"};n==="deleted_log"&&delete s.id;const c=Object.keys(s);if(!c.length)throw new Error(`表 ${n} 缺少欄位資料`);for(const d of c)if(Ur(d,n),!r.columns.has(d))throw new Error(`表 ${n} 含不存在的欄位：${d}`);for(const d of r.required)if(hr(s[d]))throw new Error(`表 ${n} 缺少必要欄位：${d}`);Ms(n,r,s),Fs(n,s)}}}function xs(e){try{return JSON.parse(String(e??""))}catch{throw new Error("JSON 格式錯誤")}}function Gs(e){const t=e?.ledger_id??e?.tables?.ledgers?.[0]?.id;if(!t)throw new Error("JSON 缺少 ledger_id");const n=e?.tables?.ledgers?.find(a=>a.id===t)??e?.tables?.ledgers?.[0];if(!n)throw new Error("JSON 缺少 ledgers 資料");return{sourceLedgerId:t,ledgerRow:n}}function fn(e){const t=ks(e);return Gs(t),Bs(t),t}function Ps(e){const t=xs(e),n=Array.isArray(t?.ledgers)?t.ledgers:null;if(!n||t?.backup_scope!=="all_ledgers")return fn(t),{mode:"single",ledgerCount:1};if(!n.length)throw new Error("JSON 缺少可匯入的帳本資料");for(const a of n)fn(a);return{mode:"all_ledgers",ledgerCount:n.length}}const wr="DRIVE_RESTORE_PREVIEW_REQUIRED",mt="DRIVE_RESTORE_NOT_IMPORTABLE",js="DRIVE_RESTORE_IMPORT_FAILED_RESTORED";function yt(e,t={}){const n=String(e?.message??e??"").trim(),a=String(t.message??"").trim()||"還原前必須完成可匯入的備份預覽。預覽失敗或內容無法解析時，禁止進入清空本機流程。",r=new Error(a);return r.code=wr,r.i18nKey=t.i18nKey||"settings_auto_backup.drive_browser.preview_required",r.originalMessage=n,r.silentWipeBlocked=!0,r}function z(e,t={}){const n=String(e?.message??e??"").trim(),a=String(t.parseError??"").trim(),r=String(t.message??"").trim()||`選定的 Drive 檔／舊版無法匯入（${a||n||"invalid_backup"}）。已中止，不清空本機。`,i=new Error(r);return i.code=mt,i.i18nKey=t.i18nKey||"settings_auto_backup.drive_browser.not_importable",i.parseError=a||n,i.originalMessage=n,i.silentWipeBlocked=!0,i}function Hs(e,t={}){const n=String(e?.message??e??"").trim(),a=String(t.message??"").trim()||`雲端備份匯入失敗（${n||"import_failed"}）。已從本機 durable recovery 回滾，本機資料未清空。`,r=new Error(a);if(r.code=js,r.i18nKey=t.i18nKey||"settings_auto_backup.drive_browser.import_failed_restored",r.originalMessage=n,r.localDataRestoredFromRecovery=!0,r.silentWipeBlocked=!0,e&&typeof e=="object")try{r.cause=e}catch{}return r}function Qt(e,t={}){const n=String(e??"");if(!n.trim())throw z(new Error("empty_json"),{...t,parseError:"empty_json"});const a=Dr(n);if(!a.ok)throw z(new Error(a.parseError||"invalid_backup"),{...t,parseError:a.parseError||"invalid_backup"});try{Ps(n)}catch(r){throw r?.code===mt?r:z(r,{...t,parseError:String(r?.message??"importer_structure_rejected").trim()||"importer_structure_rejected"})}return a}function kr(e,t={}){if(!e||typeof e!="object")throw yt(new Error("preview_missing"),t);if(!String(e.jsonText??"").trim())throw yt(new Error("preview_json_missing"),t);try{Qt(e.jsonText,t)}catch(n){throw n?.code===mt?yt(n,{...t,message:n.message}):n}return e}function Qd(e){try{return kr(e),!0}catch{return!1}}async function Ks({createRecoveryBackup:e,wipeFn:t,importFn:n,restoreFromRecovery:a,source:r,i18nKey:i}={}){if(typeof n!="function")throw z(new Error("import_missing"),{parseError:"import_missing"});const o=await ki({createRecoveryBackup:e,wipeFn:t,source:r,i18nKey:i});try{return{imported:await n(),recoveryProof:o}}catch(s){if(typeof a!="function")throw z(s,{parseError:"import_failed_after_wipe_no_rollback",message:`備份匯入失敗且無法回滾（缺少 restoreFromRecovery）：${String(s?.message??s??"").trim()||"import_failed"}`});try{await t()}catch(c){const d=z(s,{parseError:"import_failed_partial_clear_failed",message:`備份匯入失敗，且清除部分匯入殘留亦失敗：${String(c?.message??c??"").trim()||"partial_clear_failed"}`});throw d.localDataRestoredFromRecovery=!1,d.clearError=c,d}try{await a(o)}catch(c){const d=z(s,{parseError:"import_failed_rollback_failed",message:`備份匯入失敗，且 durable recovery 回滾亦失敗：${String(c?.message??c??"").trim()||"rollback_failed"}`});throw d.localDataRestoredFromRecovery=!1,d.rollbackError=c,d}throw Hs(s)}}async function ec({preview:e,downloadBackup:t,createRecoveryBackup:n,wipeFn:a,importBackupJson:r,restoreFromRecovery:i,source:o,i18nKey:s}={}){if(kr(e,{i18nKey:"settings_auto_backup.drive_browser.preview_required"}),typeof t!="function")throw z(new Error("download_missing"),{parseError:"download_missing"});if(typeof r!="function")throw z(new Error("import_missing"),{parseError:"import_missing"});let c;try{c=await t()}catch(u){throw u?.code===mt||u?.code===wr||u?.code===Ht?u:z(u,{parseError:"download_failed",message:`下載 Drive 備份失敗，已中止不清空本機：${String(u?.message??u??"").trim()||"download_failed"}`})}Qt(c?.jsonText,{i18nKey:"settings_auto_backup.drive_browser.not_importable"});const{imported:d,recoveryProof:E}=await Ks({createRecoveryBackup:n,wipeFn:a,importFn:()=>r(c.jsonText),restoreFromRecovery:i,source:o,i18nKey:s});return{backup:c,imported:d,recoveryProof:E}}const st="backup.google_drive",Fe="StrawMoneyBook_all_ledgers.json",C=(e,t,n)=>In(e,t,n);function Ys(){return{connected:!1,accountEmail:"",accountName:"",accountImageUrl:"",autoEnabled:!1,dataChangeAutoEnabled:!1,intervalHours:24,lastBackupFilename:"",lastBackupAt:"",lastBackupStatus:"idle",lastError:"",lastAutoCheckAt:"",lastAutoCheckStatus:"idle",lastAutoCheckReason:""}}function dt(e){const t=Ys();return!e||typeof e!="object"?t:{...t,...e,connected:!!e.connected,accountEmail:String(e.accountEmail??"").trim(),accountName:String(e.accountName??"").trim(),accountImageUrl:String(e.accountImageUrl??"").trim(),autoEnabled:!!e.autoEnabled,dataChangeAutoEnabled:!!e.dataChangeAutoEnabled,intervalHours:Ar(e.intervalHours),lastBackupFilename:String(e.lastBackupFilename??"").trim(),lastBackupAt:String(e.lastBackupAt??""),lastBackupStatus:String(e.lastBackupStatus??"idle"),lastError:String(e.lastError??""),lastAutoCheckAt:String(e.lastAutoCheckAt??""),lastAutoCheckStatus:String(e.lastAutoCheckStatus??"idle"),lastAutoCheckReason:String(e.lastAutoCheckReason??"")}}function j(e){if(!e)throw new Error(C("settings_auto_backup.error.missing_ledger_id"))}function en(){if(!A.isNativePlatform())throw new Error(C("settings_auto_backup.error.google.native_only"))}function Ws(e){return!Array.isArray(e)||!e.length?null:e.find(n=>String(n?.name??"")===Fe)??e[0]}function An(e){return{id:String(e?.id??"").trim(),name:String(e?.name??"").trim(),modifiedTime:String(e?.modifiedTime??"").trim(),size:e?.size!=null?String(e.size):""}}function On(e){const t=String(e??"").trim();return t===Fe?"all_ledgers":/^StrawMoneyBook_sync_.+\.json$/i.test(t)?"ledger_sync":/\.json$/i.test(t)?"other_json":"other"}function gt(){if(typeof window>"u")return null;const e=window.__SMB_DRIVE_APPDATA_MOCK__;return e&&typeof e=="object"?e:null}async function Lt(e,t={}){j(e),en();const n=t?.interactiveAuth!==!1,a=()=>Er({interactive:n,requireRefreshToken:!0}),r=await $e(e);if(!r.connected)throw new Error(C("settings_auto_backup.error.google.connect_required"));return{accessToken:await Ce({interactive:n,requireRefreshToken:!0}),reauthHandler:a,state:r}}function $s(e){return!e||typeof e!="object"?!1:!!(e.email||e.name||e.imageUrl)}function Me(e){return{email:String(e?.email??"").trim(),name:String(e?.name??"").trim(),imageUrl:String(e?.imageUrl??"").trim()}}function vr(e,t){const n={};return t.email&&t.email!==e.accountEmail&&(n.accountEmail=t.email),t.name&&t.name!==e.accountName&&(n.accountName=t.name),t.imageUrl&&t.imageUrl!==e.accountImageUrl&&(n.accountImageUrl=t.imageUrl),n}function Be(e){return String(e??"").trim().toLowerCase()}function ct(e={}){return{connected:!0,lastError:"",lastBackupStatus:"idle",...e}}function qs(e,t){const n=ct({accountEmail:t.email,accountName:t.name,accountImageUrl:t.imageUrl});return e?.lastAutoCheckReason==="reauth_required"&&(n.lastAutoCheckAt="",n.lastAutoCheckStatus="idle",n.lastAutoCheckReason=""),n}function Xr(e,t){const n=Be(e?.accountEmail),a=Be(t?.email);return!n||!a?!1:n!==a}async function zs(e,t){if(!t.connected)return t;const n=Me(Re());if(Xr(t,n)){const i=dt({...t,connected:!1,lastError:""});return await rt(e,st,i),i}const a=vr(t,n);if(!Object.keys(a).length)return t;const r=dt({...t,...a});return await rt(e,st,r),r}async function Fr(e=""){const t=Be(e);let n=!1;try{await Ce({interactive:!1,requireRefreshToken:!0}),n=!0}catch{n=!1}let a=Me(Re());if(t&&Be(a.email)&&Be(a.email)!==t&&(n=!1,a=Me({})),!n){const r=await kt({preferredEmail:t||e,requireRefreshToken:!0});a=Me(r?.profile??Re())}return a}function Vs(e){return A.isNativePlatform()||ur()?!0:!e||typeof e!="object"?!1:e.connected?!0:!!(e.autoEnabled||e.dataChangeAutoEnabled||e.accountEmail||e.accountName||e.accountImageUrl)}function Js(e){return ur()?!0:!e||typeof e!="object"?!1:e.connected?!0:!!(e.autoEnabled||e.dataChangeAutoEnabled||e.accountEmail||e.accountName||e.accountImageUrl)}function Zs(e){return!e||typeof e!="object"?!1:!!(e.connected||e.autoEnabled||e.dataChangeAutoEnabled||e.accountEmail||e.accountName||e.accountImageUrl)}function Qs(){return(Array.isArray(on()?.user?.auth_providers)?on().user.auth_providers:[]).some(t=>String(t?.provider??"").trim()==="google")}function ed(e,t={}){return!t?.allowInteractiveWhenGoogleLinked||!Zs(e)?!1:Qs()}async function td(e,t){if(!A.isNativePlatform()||!Vs(t))return t;let n="";try{n=String(await Ce({interactive:!1,requireRefreshToken:!0})??"").trim()}catch{return t}if(!n)return t;const a=Me(Re());if(Xr(t,a))return b(e,{connected:!1,lastError:""});const r=vr(t,a),i=ct(r);return t.connected&&!Object.keys(r).length&&!t.lastError?t:!t.connected||$s(a)?b(e,i):b(e,ct())}async function b(e,t){const n=await $e(e),a=dt({...n,...t});return await rt(e,st,a),a}function nd(e){return e.connected?e.autoEnabled?typeof navigator<"u"&&navigator.onLine===!1?"offline":is(e)?"":"not_due":"auto_disabled":e.lastError?"connect_restore_failed":"not_connected"}async function $e(e){j(e);const t=await Vn(e,st),n=dt(t);return zs(e,n)}async function Mr(e,t={}){j(e);const n=!!t.allowInteractive,a=await $e(e),r=await td(e,a),i=String(r.accountEmail||a.accountEmail||"").trim(),o=Js(r)||ed(r,t);if(!n||!o)return r;if(r.connected)try{return await Ce({interactive:!1,preferredEmail:i,requireRefreshToken:!0}),r}catch{}try{const s=await Fr(i);return b(e,ct({accountEmail:s.email,accountName:s.name,accountImageUrl:s.imageUrl}))}catch(s){const c=String(s?.message??s??"").trim();return b(e,{lastError:c||C("settings_auto_backup.error.google_connect_failed")})}}async function tc(e,t={}){return j(e),b(e,t)}async function nc(e){j(e),en();const t=await $e(e),n=await Fr(t.accountEmail);return b(e,qs(t,n))}async function rc(e){j(e);try{await ho()}catch(t){console.warn("[google-backup] sign out failed",t)}return b(e,{connected:!1,autoEnabled:!1,accountEmail:"",accountName:"",accountImageUrl:"",lastAutoCheckAt:"",lastAutoCheckStatus:"idle",lastAutoCheckReason:"",lastError:""})}async function Br(e,t={}){j(e),en();const n=t?.interactiveAuth!==!1,a=()=>Er({interactive:n,requireRefreshToken:!0});if(!(await $e(e)).connected)throw new Error(C("settings_auto_backup.error.google.connect_required"));const i=await Ce({interactive:n,requireRefreshToken:!0}),o=await Nr(),s=JSON.stringify(o,null,2),c=new Date().toISOString(),d=await us({accessToken:i,reauth:a,filename:Fe,jsonText:s}),E=await b(e,{lastBackupFilename:d.filename||Fe,lastBackupAt:d.modifiedTime||c,lastBackupStatus:"ok",lastError:""});return{filename:E.lastBackupFilename||Fe,lastBackupAt:E.lastBackupAt||c}}async function ac(e,t={}){j(e);const n=gt();if(n&&typeof n.restorePreferred=="function")return n.restorePreferred({ledgerId:e,options:t});const{accessToken:a,reauthHandler:r}=await Lt(e,t),i=await Sr({accessToken:a,reauth:r}),o=Ws(i);if(!o?.id)throw new Error(C("settings_auto_backup.error.google.restore_file_missing"));const s=await Rr({accessToken:a,reauth:r,fileId:o.id});return{filename:String(o.name??""),modifiedTime:String(o.modifiedTime??""),fileId:String(o.id??""),revisionId:"",jsonText:s}}async function ic(e,t={}){j(e);const n=gt();if(n&&typeof n.listFiles=="function"){const o=await n.listFiles({ledgerId:e,options:t});return(Array.isArray(o)?o:[]).map(s=>{const c=An(s);return{...c,kind:String(s?.kind??On(c.name))}})}const{accessToken:a,reauthHandler:r}=await Lt(e,t);return(await Sr({accessToken:a,reauth:r})).map(o=>{const s=An(o);return{...s,kind:On(s.name)}})}async function oc(e,t,n={}){j(e);const a=String(t??"").trim();if(!a)throw new Error(C("settings_auto_backup.error.google.restore_file_missing"));const r=gt();if(r&&typeof r.listRevisions=="function"){const s=await r.listRevisions({ledgerId:e,fileId:a,options:n});return Array.isArray(s)?s:[]}const{accessToken:i,reauthHandler:o}=await Lt(e,n);return ls({accessToken:i,reauth:o,fileId:a})}async function rd(e,t={},n={}){j(e);const a=String(t?.fileId??"").trim(),r=String(t?.revisionId??"").trim();if(!a)throw new Error(C("settings_auto_backup.error.google.restore_file_missing"));const i=gt();if(i&&typeof i.download=="function"){const d=await i.download({ledgerId:e,fileId:a,revisionId:r,options:n});return{fileId:a,revisionId:r,filename:String(d?.filename??t?.filename??""),modifiedTime:String(d?.modifiedTime??t?.modifiedTime??""),jsonText:String(d?.jsonText??"")}}const{accessToken:o,reauthHandler:s}=await Lt(e,n),c=await Rr({accessToken:o,reauth:s,fileId:a,revisionId:r||void 0});return{fileId:a,revisionId:r,filename:String(t?.filename??""),modifiedTime:String(t?.modifiedTime??""),jsonText:c}}async function ad(e,t={},n={}){const a=await rd(e,t,n),r=Dr(a.jsonText);let i=Xe(null),o="";try{const c=await Nr();i=Xe(c),o=String(c?.exported_at??"").trim()}catch(c){console.warn("[google-backup] local summary failed",c)}const s=ps(r,i,{remoteModifiedAt:a.modifiedTime||r.exportedAt,localModifiedAt:o||i.exportedAt});return{...a,remoteSummary:r,localSummary:i,comparison:s}}async function sc(e,t={},n={}){const a=await ad(e,t,n);if(!a.jsonText)throw new Error(C("settings_auto_backup.error.google.restore_file_missing"));return Qt(a.jsonText),{filename:a.filename,modifiedTime:a.modifiedTime,fileId:a.fileId,revisionId:a.revisionId,jsonText:a.jsonText,remoteSummary:a.remoteSummary,localSummary:a.localSummary,comparison:a.comparison}}async function dc(e){j(e);const t=new Date().toISOString();if(!A.isNativePlatform())return await b(e,{lastAutoCheckAt:t,lastAutoCheckStatus:"skipped",lastAutoCheckReason:"platform_unsupported"}),{status:"skipped",skipped:!0,reason:"platform_unsupported",checkedAt:t};const n=await Mr(e),a=nd(n);if(a){const r=(a==="not_connected"||a==="connect_restore_failed")&&(n.autoEnabled||!!n.accountEmail);return await b(e,{lastAutoCheckAt:t,lastAutoCheckStatus:r?"error":"skipped",lastAutoCheckReason:r?"reauth_required":a,...r?{lastBackupStatus:"error",lastError:C("settings_auto_backup.error.google.auto_backup_reauth_required",{detailSuffix:""})}:{}}),{status:r?"error":"skipped",skipped:!r,error:r,reason:r?"reauth_required":a,checkedAt:t}}try{const r=Re();return r?.email&&!n.accountEmail&&await b(e,{accountEmail:r.email,accountName:r.name||"",accountImageUrl:r.imageUrl||""}),await Br(e,{interactiveAuth:!1}),await b(e,{lastAutoCheckAt:t,lastAutoCheckStatus:"ok",lastAutoCheckReason:"backup_completed"}),{status:"completed",skipped:!1,reason:"backup_completed",checkedAt:t}}catch(r){const i=String(r?.code??"")==="GOOGLE_REAUTH_REQUIRED",o=String(r?.message??r??"").trim(),s=o?C("settings_auto_backup.error.detail_suffix",{detail:o}):"";return await b(e,{lastBackupStatus:"error",lastError:i?C("settings_auto_backup.error.google.auto_backup_reauth_required",{detailSuffix:s}):o||C("settings_auto_backup.error.google.auto_backup_failed"),lastAutoCheckAt:t,lastAutoCheckStatus:"error",lastAutoCheckReason:i?"reauth_required":"backup_failed",...i?{connected:!1}:{}}),{status:"error",skipped:!1,error:!0,reason:i?"reauth_required":"backup_failed",checkedAt:t}}}async function cc(e){j(e);const t=new Date().toISOString();if(!A.isNativePlatform())return await b(e,{lastAutoCheckAt:t,lastAutoCheckStatus:"skipped",lastAutoCheckReason:"platform_unsupported"}),{status:"skipped",skipped:!0,reason:"platform_unsupported",checkedAt:t};const n=await Mr(e);if(!n.connected||!n.autoEnabled||!n.dataChangeAutoEnabled){const a=n.connected?n.autoEnabled?"data_change_disabled":"auto_disabled":n.lastError?"connect_restore_failed":"not_connected",r=(a==="not_connected"||a==="connect_restore_failed")&&(n.autoEnabled||!!n.accountEmail);return await b(e,{lastAutoCheckAt:t,lastAutoCheckStatus:r?"error":"skipped",lastAutoCheckReason:r?"reauth_required":a,...r?{lastBackupStatus:"error",lastError:C("settings_auto_backup.error.google.auto_backup_reauth_required",{detailSuffix:""})}:{}}),{status:r?"error":"skipped",skipped:!r,error:r,reason:r?"reauth_required":a,checkedAt:t}}if(typeof navigator<"u"&&navigator.onLine===!1)return await b(e,{lastAutoCheckAt:t,lastAutoCheckStatus:"skipped",lastAutoCheckReason:"offline"}),{status:"skipped",skipped:!0,reason:"offline",checkedAt:t};try{const a=Re();return a?.email&&!n.accountEmail&&await b(e,{accountEmail:a.email,accountName:a.name||"",accountImageUrl:a.imageUrl||""}),await Br(e,{interactiveAuth:!1}),await b(e,{lastAutoCheckAt:t,lastAutoCheckStatus:"ok",lastAutoCheckReason:"data_change_backup_completed"}),{status:"completed",skipped:!1,reason:"data_change_backup_completed",checkedAt:t}}catch(a){const r=String(a?.code??"")==="GOOGLE_REAUTH_REQUIRED",i=String(a?.message??a??"").trim(),o=i?C("settings_auto_backup.error.detail_suffix",{detail:i}):"";return await b(e,{lastBackupStatus:"error",lastError:r?C("settings_auto_backup.error.google.data_change_backup_reauth_required",{detailSuffix:o}):i||C("settings_auto_backup.error.google.data_change_backup_failed"),lastAutoCheckAt:t,lastAutoCheckStatus:"error",lastAutoCheckReason:r?"reauth_required":"backup_failed",...r?{connected:!1}:{}}),{status:"error",skipped:!1,error:!0,reason:r?"reauth_required":"backup_failed",checkedAt:t}}}const Sn="https://accounts.google.com/gsi/client",ye=Zn(),xr=yn("GoogleIdentity");let ke=null;function X(e,t="google_identity_error"){const n=new Error(String(e??"").trim()||"Google identity error");return n.code=t,n}function _t(){return globalThis.google?.accounts?.id??null}function qe(){return A.getPlatform()==="web"}function _c(){return ye?qe()?!0:A.isNativePlatform()&&A.getPlatform()==="android":!1}function Ec(){return ye?qe()||A.isNativePlatform()&&A.getPlatform()==="android"?"":A.isNativePlatform()?"目前僅支援 Android App 的 Google 登入":ht():ht()}async function id(){if(!qe())throw X("Web GIS 僅支援瀏覽器環境","google_identity_web_only");return ke||(ke=new Promise((e,t)=>{const n=document.querySelector(`script[src="${Sn}"]`);if(n){n.addEventListener("load",()=>e(),{once:!0}),n.addEventListener("error",()=>t(X("Google Identity Services 載入失敗","google_gis_load_failed")),{once:!0}),_t()&&e();return}const a=document.createElement("script");a.src=Sn,a.async=!0,a.defer=!0,a.onload=()=>e(),a.onerror=()=>t(X("Google Identity Services 載入失敗","google_gis_load_failed")),document.head.appendChild(a)}).finally(()=>{_t()||(ke=null)}),ke)}function od(e){const t=String(e?.message??e??"").trim()||"Google 登入失敗",n=String(e?.code??"").trim();return X(t,n||"google_identity_native_failed")}async function uc({nonce:e}={}){if(!A.isNativePlatform()||A.getPlatform()!=="android")throw X("Credential Manager 僅支援 Android App","google_identity_android_only");if(!ye)throw X("缺少 Google Web Client ID","google_client_id_missing");if(!e)throw X("缺少 Google nonce","google_nonce_required");try{const t=await xr.signIn({serverClientId:ye,nonce:String(e).trim(),filterByAuthorizedAccounts:!1});return{idToken:String(t?.idToken??"").trim(),displayName:String(t?.displayName??"").trim(),email:String(t?.email??"").trim(),avatarUrl:String(t?.avatarUrl??"").trim()}}catch(t){throw od(t)}}async function lc(e,{nonce:t,text:n="signin_with",theme:a="outline",shape:r="pill",size:i="large",width:o=280,onCredential:s=null,onError:c=null}={}){if(!e)throw X("缺少 Google 按鈕容器","google_button_container_missing");if(!qe())throw X("Google GIS 按鈕僅支援 Web","google_identity_web_only");if(!ye)throw X("缺少 Google Web Client ID","google_client_id_missing");if(!t)throw X("缺少 Google nonce","google_nonce_required");await id();const d=_t();if(!d)throw X("Google Identity Services 尚未就緒","google_gis_not_ready");e.innerHTML="",d.initialize({client_id:ye,nonce:String(t).trim(),ux_mode:"popup",cancel_on_tap_outside:!0,callback:E=>{const u=String(E?.credential??"").trim();if(!u){const T=X("Google 未回傳 ID token","google_id_token_missing");typeof c=="function"&&c(T);return}typeof s=="function"&&s({idToken:u,selectBy:String(E?.select_by??"").trim()})},error_callback:E=>{typeof c=="function"&&c(X(String(E?.type??"Google 登入失敗"),"google_gis_error"))}}),d.renderButton(e,{type:"standard",theme:a,text:n,shape:r,size:i,logo_alignment:"left",width:o})}async function Tc(){if(qe()){_t()?.disableAutoSelect?.();return}if(A.isNativePlatform()&&A.getPlatform()==="android")try{await xr.clearCredentialState()}catch{}}export{Vd as $,Ld as A,wt as B,Ce as C,qn as D,ni as E,At as F,Ji as G,Ar as H,Nr as I,is as J,cc as K,Mi as L,dc as M,Br as N,Ps as O,ks as P,Gs as Q,vs as R,Fs as S,Yn as T,kd as U,fd as V,na as W,ta as X,wi as Y,Zd as Z,Jd as _,zi as a,Ad as a$,zd as a0,ur as a1,bi as a2,kt as a3,Sr as a4,us as a5,Rr as a6,Re as a7,Er as a8,md as a9,Fd as aA,Gd as aB,ud as aC,ki as aD,Wi as aE,Si as aF,Ht as aG,Qt as aH,Ks as aI,mt as aJ,js as aK,ld as aL,ic as aM,ad as aN,Qd as aO,oc as aP,kr as aQ,ec as aR,sc as aS,wr as aT,qd as aU,nc as aV,rc as aW,tc as aX,$e as aY,ac as aZ,Bd as a_,Td as aa,Zi as ab,Qi as ac,Oi as ad,Mr as ae,Hd as af,Vo as ag,$d as ah,jd as ai,ts as aj,Kd as ak,Md as al,Wd as am,Pd as an,Rd as ao,uc as ap,Tc as aq,lc as ar,_c as as,Ec as at,Nd as au,gr as av,Yd as aw,xd as ax,vd as ay,Xd as az,bd as b,Dd as b0,Od as c,eo as d,yd as e,Vi as f,Vn as g,Pe as h,Hn as i,no as j,ro as k,Ed as l,Sd as m,zn as n,Ud as o,wd as p,W as q,Et as r,rt as s,Cd as t,Id as u,hd as v,qi as w,gd as x,vi as y,pd as z};
